...
function drags(t, e, n, i, o) {
    ...
    t.on("mousedown touchstart", (function(a) {
        ...
        var r = t.outerWidth(),
            s = t.offset().left + r - (a.originalEvent.touches ? a.originalEvent.touches[0].clientX : a.pageX),
            l = n.offset().left,
            c = n.outerWidth(),
            u = l + 10,
            d = l + c - r - 10;
        t.parent().bind("mousemove touchmove", (function(t) {
            var a = (t.originalEvent.touches ? t.originalEvent.touches[0].clientX : t.pageX) + s - r;
            a < u ? a = u : a > d && (a = d);
            var h = 100 * (a + r / 2 - l) / c + "%";
            $(".cd-draggable", n).css("left", h).one("mouseup touchend", (function() {
                $(this).removeClass("cd-draggable"), e.removeClass("cd-resizable")
            })), $(".cd-resizable", n).css("width", h), updateLabel(o, e, "left"), updateLabel(i, e, "right")
...
function portfolioLightboxOpen(t, e, n) {
    ...
    if (lastItemId != t) {
        ...
        if (o.length) {
            ...
            for (var s in "portfolioLightboxHideCounterOnSingleItems" in window && 1 == i.dynamicEl.length && (i.counter = !1), o) {
                var l;
                if ((l = o[s]).href && l.href.match(/vimeo\.com.*?\?.*?h=.+/)) {
                    var u = l.href.match(/vimeo\.com.*?\?.*?h=(?<h>[^&]+)/);
                    u && (i.vimeoPlayerParams = {
                        h: u.groups.h
                    })
                }
            }
            jQuery(document.body).trigger("kalium_portfolio_lightbox_open", [i, c]), c.lightGallery(i), i.startClass.match(/lg-kalium-light/) && c.on("onAfterOpen.lg", (function(t) {
    ...
    $.throttle = n = function(t, n, i, o) {
        function a() {
            ...
            var c = this,
                u = +new Date - s,
                d = arguments;
            o && !r && a(), r && clearTimeout(r), o === e && u > t ? a() : !0 !== n && (r = setTimeout(o ? l : a, o === e ? t - u : t))
        }
        var r, s = 0;
        return "boolean" != typeof n && (o = i, i = n, n = e), $.guid && (a.guid = i.guid = i.guid || $.guid++), a
...
function(t, e) {
    ...
    var r = n.documentElement,
        ...
        y = function(t, e) {
            return g[e] || (g[e] = new RegExp("(\\s|^)" + e + "(\\s|$)")), g[e].test(t[c]("class") || "") && g[e]
        },
        b = function(t, e) {
        ...
        x = function(t, n) {
            var i;
            !s && (i = e.picturefill || a.pf) ? (n && n.src && !t[c]("srcset") && t.setAttribute("srcset", n.src), i({
                reevaluate: !0,
                elements: [t]
            })) : n && n.src && (t.src = n.src)
        },
        ...
        M = (_ = [], H = E = [], D = function() {
            var t = H;
            for (H = E.length ? _ : E, A = !0, I = !1; t.length;) t.shift()();
            A = !1
        }, P = function(t, e) {
            A && !e ? t.apply(this, arguments) : (H.push(t), I || (I = !0, (n.hidden ? d : h)(D)))
        }, P._lsFlush = D, P),
        A, I, E, _, H, D, P, j = function(t, e) {
            return e ? function() {
                M(t)
            } : function() {
                var e = this,
        ...
        O = (G = /^img$/i, J = /^iframe$/i, Z = "onscroll" in e && !/(gle|ing)bot/.test(navigator.userAgent), tt = 0, et = 0, nt = 0, it = -1, ot = function(t) {
            nt--, (!t || nt < 0 || !t.target) && (nt = 0)
        }, at = function(t) {
            return null == U && (U = "hidden" == T(n.body, "visibility")), U || !("hidden" == T(t.parentNode, "visibility") && "hidden" == T(t, "visibility"))
        }, rt = function(t, e) {
            var i, o = t,
                a = at(t);
            for (B -= e, q += e, X -= e, Q += e; a && (o = o.offsetParent) && o != n.body && o != r;)(a = (T(o, "opacity") || 1) > 0) && "visible" != T(o, "overflow") && (i = o.getBoundingClientRect(), a = Q > i.left && X < i.right && q > i.top - 1 && B < i.bottom + 1);
            return a
        }, lt = F(st = function() {
            var t, e, i, s, l, u, d, h, f, p, m, g, v = o.elements;
            if ((Y = a.loadMode) && nt < 8 && (t = v.length)) {
                for (e = 0, it++; e < t; e++)
                    if (v[e] && !v[e]._lazyRace)
                        if (!Z || o.prematureUnveil && o.prematureUnveil(v[e])) mt(v[e]);
                        else if ((h = v[e][c]("data-expand")) && (u = 1 * h) || (u = et), p || (p = !a.expand || a.expand < 1 ? r.clientHeight > 500 && r.clientWidth > 500 ? 500 : 370 : a.expand, o._defEx = p, m = p * a.expFactor, g = a.hFac, U = null, et < m && nt < 1 && it > 2 && Y > 2 && !n.hidden ? (et = m, it = 0) : et = Y > 1 && it > 1 && nt < 6 ? p : 0), f !== u && (N = innerWidth + u * g, V = innerHeight + u, d = -1 * u, f = u), i = v[e].getBoundingClientRect(), (q = i.bottom) >= d && (B = i.top) <= V && (Q = i.right) >= d * g && (X = i.left) <= N && (q || Q || X || B) && (a.loadHidden || at(v[e])) && (W && nt < 3 && !h && (Y < 3 || it < 4) || rt(v[e], u))) {
                    if (mt(v[e]), l = !0, nt > 9) break
                } else !l && W && !s && nt < 4 && it < 4 && Y > 2 && (R[0] || a.preloadAfterLoad) && (R[0] || !h && (q || Q || X || B || "auto" != v[e][c](a.sizesAttr))) && (s = R[0] || v[e]);
                s && !l && mt(s)
            }
        }), ut = j(ct = function(t) {
            var e = t.target;
            e._lazyCache ? delete e._lazyCache : (ot(t), b(e, a.loadedClass), w(e, a.loadingClass), C(e, dt), k(e, "lazyloaded"))
        }), dt = function(t) {
            ut({
                target: t.target
            })
            ...
            (e = a.customMedia[t[c]("data-media") || t[c]("media")]) && t.setAttribute("media", e), n && t.setAttribute("srcset", n)
        }, pt = j((function(t, e, n, i, o) {
            var r, s, l, u, h, f;
            (h = k(t, "lazybeforeunveil", e)).defaultPrevented || (i && (n ? b(t, a.autosizesClass) : t.setAttribute("sizes", i)), s = t[c](a.srcsetAttr), r = t[c](a.srcAttr), o && (u = (l = t.parentNode) && p.test(l.nodeName || "")), f = e.firesLoad || "src" in t && (s || r || u), h = {
                target: t
            }, b(t, a.loadingClass), f && (clearTimeout(K), K = d(ot, 2500), C(t, dt, !0)), u && v.call(l.getElementsByTagName("source"), ft), s ? t.setAttribute("srcset", s) : r && !u && (J.test(t.nodeName) ? ht(t, r) : t.src = r), o && (s || u) && x(t, {
                src: r
            })), t._lazyRace && delete t._lazyRace, w(t, a.lazyClass), M((function() {
                var e = t.complete && t.naturalWidth > 1;
                f && !e || (e && b(t, a.fastLoadedClass), ct(h), t._lazyCache = !0, d((function() {
            ...
            if (!t._lazyRace) {
                var e, n = G.test(t.nodeName),
                    ...
                    o = "auto" == i;
                (!o && W || !n || !t[c]("src") && !t.srcset || t.complete || y(t, a.errorClass) || !y(t, a.lazyClass)) && (e = k(t, "lazyunveilread").detail, o && bt.updateElem(t, !0, t.offsetWidth), t._lazyRace = !0, nt++, pt(t, e, o, i, n))
            }
        }, gt = L((function() {
            a.loadMode = 3, lt()
        })), yt = function() {
            W || (i.now() - z < 999 ? d(yt, 999) : (W = !0, a.loadMode = 3, lt(), u("scroll", vt, !0)))
        }, {
            _: function() {
                z = i.now(), o.elements = n.getElementsByClassName(a.lazyClass), R = n.getElementsByClassName(a.lazyClass + " " + a.preloadClass), u("scroll", lt, !0), u("resize", lt, !0), u("pageshow", (function(t) {
                    if (t.persisted) {
                ...
                })), e.MutationObserver ? new MutationObserver(lt).observe(r, {
                    childList: !0,
                    subtree: !0,
                    attributes: !0
                }) : (r[l]("DOMNodeInserted", lt, !0), r[l]("DOMAttrModified", lt, !0), setInterval(lt, 999)), u("hashchange", lt, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend"].forEach((function(t) {
                    n[l](t, lt, !0)
                })), /d$|^c/.test(n.readyState) ? yt() : (u("load", yt), n[l]("DOMContentLoaded", lt), d(yt, 2e4)), o.elements.length ? (st(), M._lsFlush()) : lt()
            },
            checkElems: lt,
            unveil: mt,
            _aLSL: vt = function() {
                3 == a.loadMode && (a.loadMode = 2), gt()
            }
        }),
        R, W, K, Y, z, N, V, B, X, Q, q, U, G, J, Z, tt, et, nt, it, ot, at, rt, st, lt, ct, ut, dt, ht, ft, pt, mt, gt, vt, yt, bt = (Ct = j((function(t, e, n, i) {
            var o, a, r;
            ...
            o && (n = S(t, o, n), (i = k(t, "lazybeforesizes", {
                width: n,
                dataAttr: !!e
            })).defaultPrevented || (n = i.detail.width) && n !== t._lazysizesWidth && Ct(t, o, i, n))
        }, {
            _: function() {
                wt = n.getElementsByClassName(a.autosizesClass), u("resize", Tt)
            },
            checkElems: Tt = L((function() {
                var t, e = wt.length;
                if (e)
                    for (t = 0; t < e; t++) kt(wt[t])
            })),
            updateElem: kt
        }),
        wt, Ct, kt, xt, Tt, St = function() {
            !St.i && n.getElementsByClassName && (St.i = !0, bt._(), O._())
        };
    return d((function() {
        a.init && St()
    })), o = {
...
function(t) {
    ...
    var t = {
        ...
        a = function(t, e, r, s) {
            if (Math.sqrt((r.pX - n) * (r.pX - n) + (r.pY - i) * (r.pY - i)) < s.sensitivity) return e.off(r.event, o), delete r.timeoutId, r.isActive = !0, t.pageX = n, t.pageY = i, delete r.pX, delete r.pY, s.over.apply(e[0], [t]);
            r.pX = n, r.pY = i, r.timeoutId = setTimeout((function() {
                a(t, e, r, s)
            }), s.interval)
        },
        r = function(t, e, n, i) {
    ...
    $.fn.hoverIntent = function(n, i, s) {
        var l = e++,
            c = $.extend({}, t);
        $.isPlainObject(n) ? (c = $.extend(c, n), $.isFunction(c.out) || (c.out = c.over)) : c = $.isFunction(i) ? $.extend(c, {
            over: n,
            out: i,
            selector: s
        }) : $.extend(c, {
        ...
        var u = function(t) {
            ...
            var u = s.event = "mousemove.hoverIntent.hoverIntent" + l;
            if ("mouseenter" === t.type) {
                if (s.isActive) return;
                s.pX = e.pageX, s.pY = e.pageY, n.off(u, o).on(u, o), s.timeoutId = setTimeout((function() {
                    a(e, n, s, c)
                }), c.interval)
            } else {
                if (!s.isActive) return;
                n.off(u, o), s.timeoutId = setTimeout((function() {
                    r(e, n, s, c.out)
                }), c.timeout)
            }
        };
    ...
    $.fn.addBack = $.fn.addBack || $.fn.andSelf, $.fn.extend({
        actual: function(t, e) {
            ...
            var n = {
                ...
                o = this.eq(0),
                a, r;
            if (!0 === i.clone) a = function() {
                var t = "position: absolute !important; top: -1000 !important; ";
                o = o.clone().attr("style", t).appendTo("body")
            }, r = function() {
                o.remove()
            };
            else {
                var s = [],
                    ...
                    c;
                a = function() {
                    c = o.parents().addBack().filter(":hidden"), l += "visibility: hidden !important; display: " + i.display + " !important; ", !0 === i.absolute && (l += "position: absolute !important; "), c.each((function() {
                        var t = $(this),
                            e = t.attr("style");
                        s.push(e), t.attr("style", e ? e + ";" + l : l)
                    }))
                }, r = function() {
                    c.each((function(t) {
                        var e = $(this),
                            n = s[t];
                        void 0 === n ? e.removeAttr("style") : e.attr("style", n)
                    }))
                }
            }
            a();
            var u = /(outer)/.test(t) ? o[t](i.includeMargin) : o[t]();
            return r(), u
        }
    })
})),
...
function(t, e) {
    ...
    function r(t, e) {
        ...
        n.contains(i) ? clearTimeout(M[e]) : n.add(i)
    }
    ...
    function m(t) {
        ...
        t.containerWidth = Math.round(i.width), t.containerHeight = Math.round(i.height), t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (a(e, S.element.rail("x")).forEach((function(t) {
            return o(t)
        })), e.appendChild(t.scrollbarXRail)), e.contains(t.scrollbarYRail) || (a(e, S.element.rail("y")).forEach((function(t) {
            return o(t)
    ...
    function w(t, e) {
        function n(e) {
            e.touches && e.touches[0] && (e[c] = e.touches[0].pageY), v[f] = y + w * (e[c] - b), r(t, p), m(t), e.stopPropagation(), e.type.startsWith("touch") && e.changedTouches.length > 1 && e.preventDefault()
        }

        function i() {
            s(t, p), t[g].classList.remove(S.state.clicking), t.event.unbind(t.ownerDocument, "mousemove", n)
        }

        function o(e, o) {
            y = v[f], o && e.touches && (e[c] = e.touches[0].pageY), b = e[c], w = (t[l] - t[a]) / (t[u] - t[h]), o ? t.event.bind(t.ownerDocument, "touchmove", n) : (t.event.bind(t.ownerDocument, "mousemove", n), t.event.once(t.ownerDocument, "mouseup", i), e.preventDefault()), t[g].classList.add(S.state.clicking), e.stopPropagation()
        }
        var a = e[0],
            l = e[1],
            c = e[2],
    ...
    function k(e) {
        ...
        function o(e, n, i) {
            if (!_.isWebKit && r.querySelector("select:focus")) return !0;
    ...
    function x(e) {
        function n(t, n) {
            var i = Math.floor(u.scrollTop),
                ...
                r = Math.abs(n);
            if (r > a) {
                if (n < 0 && i === e.contentHeight - e.containerHeight || n > 0 && 0 === i) return 0 === window.scrollY && n > 0 && _.isChrome
        ...
        function c() {
            e.settings.swipeEasing && (clearInterval(p), p = setInterval((function() {
                e.isInitialized ? clearInterval(p) : f.x || f.y ? Math.abs(f.x) < .01 && Math.abs(f.y) < .01 ? clearInterval(p) : e.element ? (i(30 * f.x, 30 * f.y), f.x *= .8, f.y *= .8) : clearInterval(p) : clearInterval(p)
            }), 10))
        }
    ...
    E.prototype.eventElement = function t(e) {
        var n = this.eventElements.filter((function(t) {
            return t.element === e
        }))[0];
        return n || (n = new A(e), this.eventElements.push(n)), n
    }, E.prototype.bind = function t(e, n, i) {
        this.eventElement(e).bind(n, i)
    }, E.prototype.unbind = function t(e, n, i) {
        var o = this.eventElement(e);
        o.unbind(n, i), o.isEmpty && this.eventElements.splice(this.eventElements.indexOf(o), 1)
    }, E.prototype.unbindAll = function t() {
        this.eventElements.forEach((function(t) {
            return t.unbindAll()
        })), this.eventElements = []
    }, E.prototype.once = function t(e, n, i) {
        var o = this.eventElement(e),
            a = function(t) {
                o.unbind(n, a), i(t)
            };
    ...
    var _ = {
        ...
        P = function i(o, a) {
            ...
            for (var s in this.element = o, o.classList.add(S.main), this.settings = {
                    handlers: ["click-rail", "drag-thumb", "keyboard", "wheel", "touch"],
                    maxScrollbarLength: null,
                    minScrollbarLength: null,
                    scrollingThreshold: 1e3,
            ...
            var l = function() {
                    return o.classList.add(S.state.focus)
                },
                c = function() {
                    return o.classList.remove(S.state.focus)
                },
                u, d;
            this.isRtl = "rtl" === t(o).direction, !0 === this.isRtl && o.classList.add(S.rtl), this.isNegativeScroll = (u = o.scrollLeft, d = null, o.scrollLeft = -1, d = o.scrollLeft < 0, o.scrollLeft = u, d), this.negativeScrollAdjustment = this.isNegativeScroll ? o.scrollWidth - o.clientWidth : 0, this.event = new E, this.ownerDocument = o.ownerDocument || document, this.scrollbarXRail = n(S.element.rail("x")), o.appendChild(this.scrollbarXRail), this.scrollbarX = n(S.element.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", l), this.event.bind(this.scrollbarX, "blur", c), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
            ...
            this.scrollbarXBottom = parseInt(f.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = h(f.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = h(f.borderLeftWidth) + h(f.borderRightWidth), e(this.scrollbarXRail, {
                ...
                display: ""
            }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = n(S.element.rail("y")), o.appendChild(this.scrollbarYRail), this.scrollbarY = n(S.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", l), this.event.bind(this.scrollbarY, "blur", c), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
    ...
    return P.prototype.update = function n() {
    ...
    }, P.prototype.onScroll = function t(e) {
    ...
    }, P.prototype.removePsClasses = function t() {
...
function(t) {
    ...
    function o(t, e) {
        function n(t) {
            if (0 !== t.length)
                for (y = t.length; y--;)(b = t[y]).callback.call(i, C), b.isOne && t.splice(y, 1)
        }
        var i = this,
            o, a, r, l, y, b;
        ...
        for (var w = 0, k = g.length; w < k; w++) i.callbacks[g[w]] = [];
        this.locked = !1, this.triggerCallbacks = function t() {
            switch (this.isInViewport && !o && n(this.callbacks[u]), this.isFullyInViewport && !a && n(this.callbacks[d]), this.isAboveViewport !== r && this.isBelowViewport !== l && (n(this.callbacks[c]), a || this.isFullyInViewport || (n(this.callbacks[d]), n(this.callbacks[f])), o || this.isInViewport || (n(this.callbacks[u]), n(this.callbacks[h]))), !this.isFullyInViewport && a && n(this.callbacks[f]), !this.isInViewport && o && n(this.callbacks[h]), this.isInViewport !== o && n(this.callbacks[c]), !0) {
            ...
            if (!this.locked) {
                ...
                this.top -= this.offsets.top, this.bottom += this.offsets.bottom, this.height = this.bottom - this.top, void 0 === t && void 0 === e || this.top === t && this.bottom === e || n(this.callbacks[p])
            }
...
function(t, e) {
    ...
    function o(t, e, n) {
        ...
        let a = t;
        "string" == typeof t && (a = document.querySelectorAll(t)), a ? (this.elements = i(a), this.options = {}, "function" == typeof e ? n = e : Object.assign(this.options, e), n && this.on("always", n), this.getImages(), $ && (this.jqDeferred = new $.Deferred), setTimeout(this.check.bind(this))) : s.error(`Bad element for imagesLoaded ${a||t}`)
    }
    ...
    let $ = e.jQuery,
        s = e.console;
    o.prototype = Object.create(n.prototype), o.prototype.getImages = function() {
    ...
    return o.prototype.addElementBackgroundImages = function(t) {
        ...
        for (; null !== n;) {
            let i = n && n[2];
            i && this.addBackground(i, t), n = c.exec(e.backgroundImage)
        }
...
function($) {
    $.fn.kaliumCountdown = function(t, e) {
        function n() {
            var t = Date.parse(o.date) / 1e3,
                n = Math.floor($.now() / 1e3);
            t <= n && (e.call(this), clearInterval(interval));
            var a = t - n,
                r = Math.floor(a / 86400);
            a -= 60 * r * 60 * 24;
            var s = Math.floor(a / 3600);
            a -= 60 * s * 60;
            var l = Math.floor(a / 60);
            a -= 60 * l, 1 == r ? i.find(".timeRefDays").text(i.find(".timeRefDays").data("text-singular")) : i.find(".timeRefDays").text(i.find(".timeRefDays").data("text")), 1 == s ? i.find(".timeRefHours").text(i.find(".timeRefHours").data("text-singular")) : i.find(".timeRefHours").text(i.find(".timeRefHours").data("text")), 1 == l ? i.find(".timeRefMinutes").text(i.find(".timeRefMinutes").data("text-singular")) : i.find(".timeRefMinutes").text(i.find(".timeRefMinutes").data("text")), 1 == a ? i.find(".timeRefSeconds").text(i.find(".timeRefSeconds").data("text-singular")) : i.find(".timeRefSeconds").text(i.find(".timeRefSeconds").data("text")), "on" == o.format && (r = String(r).length >= 2 ? r : "0" + r, s = String(s).length >= 2 ? s : "0" + s, l = String(l).length >= 2 ? l : "0" + l, a = String(a).length >= 2 ? a : "0" + a), isNaN(t) ? (alert("Invalid date. Here's an example: 12 Tuesday 2012 17:30:00"), clearInterval(interval)) : (i.find(".days").text(r), i.find(".hours").text(s), i.find(".minutes").text(l), i.find(".seconds").text(a))
        }
        var i = $(this),
            o = {
                date: null,
        ...
        t && $.extend(o, t), n(), interval = setInterval(n, 1e3)
    }
        ...
        t.prototype = {
            ...
            return this.each((function() {
                var n = $(this),
                    i = n.data("typed"),
                    o = "object" == typeof e && e;
                i && i.reset(), n.data("typed", i = new t(this, o)), "string" == typeof e && i[e]()
            }))
        }, $.fn.typed.defaults = {
    ...
    function($) {
        ...
        e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
            ...
            for (var i = this.options.trigger.split(" "), o = i.length; o--;) {
                var a = i[o];
                if ("click" == a) this.$element.on("click." + this.type, this.options.selector, $.proxy(this.toggle, this));
                else if ("manual" != a) {
                    var r = "hover" == a ? "mouseenter" : "focusin",
                        s = "hover" == a ? "mouseleave" : "focusout";
                    this.$element.on(r + "." + this.type, this.options.selector, $.proxy(this.enter, this)), this.$element.on(s + "." + this.type, this.options.selector, $.proxy(this.leave, this))
                }
            }
            ...
            if (e || (e = new this.constructor(t.currentTarget, this.getDelegateOptions()), $(t.currentTarget).data("bs." + this.type, e)), t instanceof $.Event && (e.inState["focusin" == t.type ? "focus" : "hover"] = !0), e.tip().hasClass("in") || "in" == e.hoverState) e.hoverState = "in";
            else {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                if (l) {
                    ...
                    r = "bottom" == r && c.bottom + d > f.bottom ? "top" : "top" == r && c.top - d < f.top ? "bottom" : "right" == r && c.right + u > f.width ? "left" : "left" == r && c.left - u < f.left ? "right" : r, o.removeClass(h).addClass(r)
                }
                var p = this.getCalculatedOffset(r, c, u, d);
            ...
            isNaN(a) && (a = 0), isNaN(r) && (r = 0), t.top += a, t.left += r, $.offset.setOffset(n[0], $.extend({
                using: function(t) {
                    n.css({
            ...
            var i = this,
                o = $(this.$tip),
                a = $.Event("hide.bs." + this.type);
            if (this.$element.trigger(a), !a.isDefaultPrevented()) return o.removeClass("in"), $.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", n).emulateTransitionEnd(e.TRANSITION_DURATION) : n(), this.hoverState = null, this
    ...
    function($) {
        ...
        n.VERSION = "3.3.7", n.TRANSITION_DURATION = 150, n.prototype.close = function(t) {
            ...
            var a = $("#" === o ? [] : o);
            t && t.preventDefault(), a.length || (a = i.closest(".alert")), a.trigger(t = $.Event("close.bs.alert")), t.isDefaultPrevented() || (a.removeClass("in"), $.support.transition && a.hasClass("fade") ? a.one("bsTransitionEnd", e).emulateTransitionEnd(n.TRANSITION_DURATION) : e())
        };
        var i = $.fn.alert;
    ...
    function($) {
        ...
        function e(e) {
            e && 3 === e.which || ($(i).remove(), $(o).each((function() {
                ...
                i.hasClass("open") && (e && "click" == e.type && /input|textarea/i.test(e.target.tagName) && $.contains(i[0], e.target) || (i.trigger(e = $.Event("hide.bs.dropdown", o)), e.isDefaultPrevented() || (n.attr("aria-expanded", "false"), i.removeClass("open").trigger($.Event("hidden.bs.dropdown", o)))))
            })))
        }
        ...
        function n(t) {
            return this.each((function() {
                ...
                n || e.data("bs.dropdown", n = new a(this)), "string" == typeof t && n[t].call(e)
            }))
        }
        ...
        a.VERSION = "3.3.7", a.prototype.toggle = function(n) {
            ...
            if (!i.is(".disabled, :disabled")) {
                ...
                if (e(), !a) {
                    ...
                    if (o.trigger(n = $.Event("show.bs.dropdown", r)), n.isDefaultPrevented()) return;
                    i.trigger("focus").attr("aria-expanded", "true"), o.toggleClass("open").trigger($.Event("shown.bs.dropdown", r))
                }
                return !1
            }
            ...
            if (/(38|40|27|32)/.test(e.which) && !/input|textarea/i.test(e.target.tagName)) {
                ...
                if (e.preventDefault(), e.stopPropagation(), !n.is(".disabled, :disabled")) {
                    var i = t(n),
                        a = i.hasClass("open");
                    if (!a && 27 != e.which || a && 27 == e.which) return 27 == e.which && i.find(o).trigger("focus"), n.trigger("click");
                    var r = " li:not(.disabled):visible a",
                        s = i.find(".dropdown-menu" + r);
                    if (s.length) {
        ...
        var r = $.fn.dropdown;
        $.fn.dropdown = n, $.fn.dropdown.Constructor = a, $.fn.dropdown.noConflict = function() {
    ...
    function($, t, e) {
        "use strict";
        var n = $("body").hasClass("kalium-debug"),
            i = Array.prototype.forEach,
            o = Function.prototype.call.bind(i),
            a = !1,
            r = [],
            s = function(t) {
                var n = !0;
                return o(t, (function(t) {
                    if (e == u.prototype[t]) return n = !1, !1
                })), n
            },
            l = function(t) {
                var e = [];
            ...
            c = function() {
                o(r, (function(t) {
                    !t.fired && s(t.require) && (t.fn.apply(d, l(t.require)), t.fired = !0)
                }))
            },
            u = function() {};
        u.version = "0.2", u.prototype = {
            ...
            extend: function(t) {
                var e = 0;
                if ("object" == typeof t)
                    for (var n in t) u.prototype[n] = t[n], e++;
                a && e > 0 && c()
            },
            ready: function(t, e) {
    ...
    function($, t, e) {
        ...
        $.extend(i, {
            attachedHooks: {},
            get: function(t) {
                return t in i.attachedHooks ? i.attachedHooks[t] : null
            },
            getIndex: function(t) {
                var e = -1;
                return t instanceof n && $.each(i.get(t.getTag()), (function(n, i) {
                    if (i.equals(t)) return e = n, !1
                })), e
            },
            register: function(t) {
                0 == t.getTag() in i.attachedHooks && (i.attachedHooks[t.getTag()] = []), -1 == i.getIndex(t) && (i.attachedHooks[t.getTag()].push(t), i.reorderHooks(t.getTag()))
            },
            remove: function(t, e, o, a) {
                var r = new n(t, e, o, a),
                    s = i.getIndex(r);
                s >= 0 && (i.attachedHooks[r.getTag()] = i.attachedHooks[r.getTag()].filter((function(t, e) {
                    return s !== e
                })))
            },
            reorderHooks: function(t) {
                t in i.attachedHooks && ($.each(i.attachedHooks[t], (function(t, e) {
                    e._priority = "number" == typeof e.getPriority() ? e.getPriority() : t
                })), i.attachedHooks[t] = i.attachedHooks[t].sort((function(t, e) {
            ...
            addFilter: function(t, e, o, a) {
                i.register(new n(t, e, o, a))
            },
            applyFilters: function(e, n) {
                var e, n, o = [];
                if (arguments.length > 2)
                    for (var a = 2; a < arguments.length; a++) o.push(arguments[a]);
                return $.each(i.get(e), (function(e, i) {
                    var a = "function" == typeof i.getCallback() ? i.getCallback() : t[i.getCallback()];
                    if ("function" == typeof a) {
                        var r = "number" == typeof i.getArgsNum() && i.getArgsNum() > 1 ? i.getArgsNum() - 1 : 0,
                            s = o.slice(0, r);
                        s.unshift(n), n = a.apply(a, s)
                    }
                })), n
            },
            removeFilter: function(t, e, n, o) {
                i.remove(t, e, n, o)
            },
            addAction: function() {
                var t = [];
            ...
            doAction: function(e) {
                ...
                if (arguments.length > 1)
                    for (var o = 1; o < arguments.length; o++) n.push(arguments[o]);
                $.each(i.get(e), (function(e, i) {
                    var o = "function" == typeof i.getCallback() ? i.getCallback() : t[i.getCallback()];
                    if ("function" == typeof o) {
                        var a = "number" == typeof i.getArgsNum() && i.getArgsNum() > 1 ? i.getArgsNum() : 1,
                            r = n.slice(0, a);
                        o.apply(o, r)
                    }
                }))
    ...
    function($, t, e) {
        ...
        function n() {
            $(".standard-toggle-menu").each((function(t, e) {
                var n = $(e),
                    i = n.find(".toggle-bars"),
                    o = n.find(".menu > .menu-item"),
                    a = i.data("toggle-id"),
                    r = n.data("toggle-effect"),
                    s = n.data("stagger-direction"),
                    l = "menu-item--visible",
                    c = {
                        autoAlpha: 0
                    },
                ...
                if (!n.data("toggle-id")) {
                    if (a) {
                        var h = n.closest(".header-block__column").find('[data-toggle-id="' + a + '"]');
                        h.length && (o = h.find(".menu > .menu-item"))
                    }
                    switch ("right" === s && (o = $(o.get().reverse())), r) {
                        case "fade":
                            break;
                        case "slide-left":
                        case "slide-right":
                            $.extend(c, {
                                x: 10 * ("slide-left" === r ? -1 : 1)
                            }), $.extend(u, {
                                x: 0
                            });
                            break;
                    ...
                    d.fromTo(o, c, u), i.on("click", (function(t) {
                        t.preventDefault(), i.hasClass("exit") ? (i.removeClass("exit"), Kalium.Header.isMobileView() || d.reverse()) : (i.addClass("exit"), Kalium.Header.isMobileView() || d.play())
                    }))
                }
            }))
        }
        var i = function() {
            n(), $(".header-block__item .toggle-bars").on("click", (function(t) {
                t.preventDefault(), Kalium.Header.isMobileView() && Kalium.Header.mobileMenuToggle()
            }))
        };
        i.prototype.isMobileView = function() {
            var e = 768;
            return "number" == typeof mobile_menu_breakpoint && (e = mobile_menu_breakpoint), $(t).width() <= e
        }, i.prototype.mobileMenuOpen = function() {
            publicVars.$body.addClass("mobile-menu-open"), Kalium.Header.repositionMobileMenuToggleBars()
        }, i.prototype.mobileMenuClose = function() {
            publicVars.$body.removeClass("mobile-menu-open")
        }, i.prototype.mobileMenuToggle = function() {
            publicVars.$body.hasClass("mobile-menu-open") ? this.mobileMenuClose() : this.mobileMenuOpen()
        }, i.prototype.repositionMobileMenuToggleBars = function() {
            var e = $(".mobile-menu-close-link"),
                n = $(".site-header .toggle-bars").last();
    ...
    function($, t, e) {
        ...
        var n = function(t) {
                ...
                var e = $(this).closest(".vc_grid"),
                    n = e.find(".kalium-lightbox-entry"),
                    i = this,
                    o = {
                        index: 0,
                        items: [],
                ...
                return n.each((function(t, e) {
                    ...
                    var n = $(e),
                        a = n.attr("href"),
                        r = n.closest(".vc_grid-item-mini"),
                        s = r.find(".vc_gitem-zone-img "),
                        l = s.length ? s.attr("src") : n.next().attr("src"),
                        c = {
                            caption: n.attr("title"),
                            thumbnail: l
                        };
                    if (l.match(/vc_gitem_image\.png/)) {
                        var u = r.find(".vc_gitem-zone-a").css("background-image"),
                            d = null;
                        u && (d = u.match(/url\((.*?)\)/)) && (d = d[1].replace(/"/g, "")) && (c.thumbnail = d)
                    }
                    var h = new Kalium.Media.Lightbox_Item(a, c);
                    l || (o.options.lightGalleryOptions.thumbnail = !1), o.items.push(h)
            ...
            o = function() {
                $.each(Kalium.getVar("kalium_wpb_lightbox_items"), (function(t, e) {
                    var n = $('[data-lightbox-container="' + e.container + '"]');
                    if ("vc_single_image" == e.tag) {
                        var i = n.find(".vc_single_image-img"),
                            o = new Kalium.Media.Lightbox_Item(e.image, {
                                caption: i.attr("title")
                            });
                        i.addClass("kalium-lightbox-entry--single").on("click", (function(t) {
                            t.preventDefault(), Kalium.Media.lightbox(i, {
                                items: o,
                                options: {
                                    lightGalleryOptions: {
                                        counter: !1
                        ...
                        var a = n.find(".wpb_image_grid_ul li img, .vc_images_carousel .vc_item img, .wpb_gallery_slides li img"),
                            r = [];
                        a.each((function(t, n) {
                            var i = $(n),
                            ...
                            r.push(o), i.addClass("kalium-lightbox-entry--gallery").on("click", (function(e) {
                                e.preventDefault(), Kalium.Media.lightbox(i, {
                                    items: r,
                                    index: t,
                                    options: {
                                        lightGalleryOptions: {
            ...
            a = function() {
                if ($().lightGallery) {
                    var e = {
                        ...
                        n = function() {
                            $(".light-gallery--enabled").each((function(t, n) {
                                var i = $(n);
                                if (!i.data("lg-init")) {
                                    var o = i.find(".vc_gitem-zone > a, .vc_gitem-zone-a > a, a:has(> img)").filter((function(t, e) {
                                        return $(e).attr("href").match(/\.(png|jpe?g|gif)$/i)
                                    }));
                                    o.removeClass("prettyphoto").unbind("click").attr("data-rel", "").on("click", (function(t) {
                                        return !1
                                    })), 0 < o.length && (kaliumLightbox(i, $.extend(e, {
                                        thumbnail: o.find("img").length > 0
                                    })), i.data("lg-init", !0))
                                }
                            }))
                        };
                    $(t).on("grid:items:added", $.debounce(50, n)), n()
                }
            },
            r = function() {
                i(!0), $(t).on("grid:items:added", i), Kalium.getVar("kalium_wpb_lightbox_items") && o(), a()
            },
            s = function() {
                this.init()
            };
        s.prototype = {
            constructor: s,
            init: function() {
                this.didInit || ($(document).ready(r), this.didInit = !0)
            }
        }, e.extend({
            WPBakery: new s
        })
    ...
    function($, t, e) {
        "use strict";
        var n = function() {
                n.selfhostedLoaded || "function" != typeof videojs || (this.VideoJS = new i, n.selfhostedLoaded = !0), n.vimeoLoaded || "object" != typeof t.Vimeo || (this.Vimeo = new o, n.vimeoLoaded = !0), n.youtubeLoaded || (this.YouTube = new a, n.youtubeLoaded = !0), n.loaded = !0
            },
            i = function() {
        ...
        }, i.prototype.setupVideoJSElement = function(e) {
            if ("function" == typeof videojs) {
                var n = this,
                    i = $(e);
                if (i.data("videojs-init") || e.player) return;
                i.addClass("video-js");
                var o = i.data("vsetup"),
                    a = videojs(i.get(0), o);
                if ("techOrder" in o && -1 !== $.inArray("youtube", o.techOrder) && "YT" in t && YT.ready($.debounce(100, (function() {
                        a.trigger("ready")
                    }))), i.data("autosize") && $("#" + a.id()).css({
                        paddingBottom: a.height() / a.width() * 100 + "%"
                    }), void 0 !== i.attr("data-hide-controls-on-play")) {
                    a.controls(!0);
                    var r = function(t) {
                        a.controls(!0)
                    };
                    a.on("play", (function() {
                        a.controls(!1)
                    })), a.on("end", r), a.on("abort", r), a.on("pause", r), a.on("error", r)
                }
                a.on("ready", (function() {
                    var t = this,
                        e = $(t.el_),
                        n;
                    e.addClass("video-js-init"), a.on("play", (function() {
                        is.safari() && t.poster() && t.poster("")
                    })), e.is("[autoplay]") && (n = 1, Kalium.Hooks.applyFilters("Kalium.Media.VideoJS.pauseAutoPlayVideos", !0) && a.muted(!0), $.debounce(100, (function() {
                        if (void 0 !== t) {
                            var e = t.play();
                            e instanceof Promise && e.then((function() {
                                n = 2
                            })).catch((function(t) {
                                n = 3
                            }))
                        }
                    }))()), "on-viewport" === i.data("autoplay") && Kalium.Media.enterViewport(e, (function() {
                        "no" !== i.data("autoplay-pause-others") && Kalium.Media.pauseAllPlayers(t), t.play(), $.debounce(500, (function() {
                            t.paused() && t.play()
                        }))()
                    })), e.parent(".video").addClass("loaded"), a.on("play", (function() {
                        "no" !== i.data("autoplay-pause-others") && (void 0 === n || n > 1) && Kalium.Media.pauseAllPlayers(a)
                    })), i.trigger("videojs-init", [a])
        ...
        }, o.prototype.setupVimeoElement = function(e) {
            var n = this,
                i = $(e),
                o = i.find("iframe");
            if (!i.data("vimeo-init")) {
                var a = new t.Vimeo.Player(o);
                i.data("player", a), this.players.push(a), i.hasClass("autoplay-on-viewport") && Kalium.Media.enterViewport(i, (function() {
                    Kalium.Media.pauseAllPlayers(a), a.play()
                })), a.on("play", (function(t) {
                    Kalium.Media.pauseAllPlayers(a)
                })), i.addClass("loaded"), i.data("vimeo-init", !0)
            }
        ...
        a.prototype.loadAPI = function(e) {
            ...
            if ($(".video.video-youtube").length) {
                ...
                this.loadAPI((function() {
                    $(".video.video-youtube").each((function(e, n) {
                        t.setupYouTubeElement(n)
                    }))
                }))
            }
        }, a.prototype.setupYouTubeElement = function(t) {
            var e = this,
                n = $(t),
                i = "youtube-embed-" + (this.players.length + 1),
                o = n.find("iframe");
            if (!n.data("youtube-init")) {
                o.attr("id", i);
                var a = new YT.Player(i, {
                    events: {
                        onReady: function() {
                            n.data("player", a), e.players.push(a), n.hasClass("autoplay-on-viewport") && Kalium.Media.enterViewport(n, (function() {
                                Kalium.Media.pauseAllPlayers(a), a.playVideo()
                            })), n.addClass("loaded")
                        },
                        onStateChange: function(t) {
                            1 === t.data && Kalium.Media.pauseAllPlayers(a)
                        }
                    }
                });
                n.data("player", a), this.players.push(a), n.data("youtube-init", !0)
            }
        ...
        var r = function(t, e) {
                ...
                "object" == typeof e ? n = $.extend(!0, n, e) : "string" == typeof e && (n.caption = e), this.src = t, this.args = n, this.getSource = function() {
                    return this.src
                ...
                if ($().lightGallery) {
                    if (this.instance = null, this.args = t, this.dynamic = "object" == typeof this.args.items && this.args.items.length > 0, this.items = [], this.dynamic)
                        for (var e in this.args.items) {
                            var n = this.args.items[e];
                            this.items.push(new r(n))
                        }
                    this.init()
        ...
        s.prototype.getOptions = function() {
            var t = this.args,
                e = t.options,
                n = e.lightGalleryOptions;
            if (e.selector && (n.selector = e.selector), 0 < e.autoplay && (n.autoplay = !0, n.pause = e.autoplay > 100 ? e.autoplay : 1e3 * e.autoplay), n.index = parseInt(t.index, 10), this.dynamic)
                for (var i in n.dynamic = !0, n.dynamicEl = [], this.args.$container = $("<div>"), this.items) {
                    var o = this.items[i];
                    if (o instanceof r) {
                        var a = {
                            src: o.getSource(),
                        ...
                        o.getThumbnail() && (a.thumb = o.getThumbnail()), o.getPoster() && (a.poster = o.getPoster()),
                            n.dynamicEl.push(a)
                    }
                }
        ...
        l.prototype.getScrollMagicController = function() {
            ...
            for (var t in n.call(this), this.providers) {
                var e = this.providers[t];
                this[e] && this[e].initVideoElements()
            }
        }, l.prototype.lightbox = function(t, e) {
            var n = "lightGallery",
                i = {
                    $container: null,
                    items: [],
            ...
            if (2 === arguments.length) {
                var o = arguments[0],
                    a = e;
                o instanceof $ && (t = e, "object" == typeof e ? t.$container = o : t = {
                    $container: o
                })
            } else if (!t) return null;
            switch (t instanceof $ || "string" == typeof t ? i.$container = t : "object" == typeof t && (i = $.extend(!0, i, t)), "string" == typeof i.$container && (i.$container = $(i.$container)), 0 == i.items instanceof Array && (i.items = [i.items]), n) {
                case "lightGallery":
                    return new s(i);
                    break
            }
            return null
        }, l.prototype.Lightbox_Item = r, e.extend({
            Media: new l
        })
    }(jQuery, window, Kalium),
    function($, t, e) {
        ...
        var n = function() {
                document.addEventListener("lazyloaded", (function(t) {
                    $(t.target).parent().addClass("loaded")
                }))
            },
            i = function() {
                this.init()
                ...
                return new Promise((function(n, i) {
                    switch (t) {
                        case "light-gallery":
                            ...
                            break;
                        case "videojs":
                            e.loadStyle("videojs").then((function() {
                                e.loadScript("videojs").then(n)
                            }));
                            break
                    }
                }))
    ...
    function($, t, e) {
        ...
        var n = function(t) {
            ...
            if (this.args = $.extend(!0, e, t), this.$sticky = $(this.args.stick), this.$durationEl = $(this.args.duration), 0 != this.$sticky.length) {
                var i = this.$sticky.data("stickyElement");
                i instanceof n && i.destroy(), this.init()
            }
        };
        n.prototype.init = function() {
            ...
            "string" == typeof this.args.scrollContainer && (e = this.$stickyWrapper.find(this.args.scrollContainer)).length && (this.subScroll = !0, this.$subScrollSiblings = e.siblings()), this.$scrollContainer = e.wrapInner($("<div>", {
            ...
            this.scrollbar = setupPerfectScrollbar(this.$scrollContainer, n)
        }, n.prototype.updateScrollContainer = function(t) {
            if (this.scrollbar)
                if (t) {
                    ...
                    if (this.subScroll) {
                        ...
                        this.$subScrollSiblings.each((function(t, e) {
                            i += $(e).outerHeight(!0)
                        })), "object" == typeof stickyHeader && "getStickyHeight" in stickyHeader && (i += stickyHeader.getHeight() - stickyHeader.getStickyHeight()), e = i = e - (i + n)
                    }
            ...
            "object" == typeof stickyHeader && "getStickyHeight" in stickyHeader && (e += stickyHeader.getStickyHeight()), Kalium.Header.Sticky && (e += Kalium.Header.Sticky.getStickyHeight() - Kalium.Header.Sticky.getOffset());
            var n = {
    ...
    function($, t, e) {
        "use strict";
        var n = function() {
            $("body").on("click", ".like-button[data-post-id]", (function(t) {
                t.preventDefault(), Kalium.Likes.like($(this).data("post-id"))
            })), $("body").on("mouseenter", ".like-button[data-post-id]:has(.like-button__count)", $.debounce(100, (function(t) {
                var e = $(this);
                this._showCounter || (this._showCounter = function() {
                    e.addClass("like-button--count-visible")
                }), this._hideCounter || (this._hideCounter = function() {
                    e.removeClass("like-button--count-visible")
                }), this._showCounter()
            }))), $("body").on("mouseleave", ".like-button[data-post-id]:has(.like-button__count)", $.debounce(100, (function(t) {
                this._hideCounter()
            })))
        };
        n.prototype.like = function(t) {
            var e = $('.like-button[data-post-id="' + t + '"]'),
                n = e.get(0),
                i = e.find(".like-icon__icon, .like-icon__bubble"),
                o = e.find(".like-button__count"),
                a = "like",
                r = "unlike";
            if (!e.hasClass("loading")) {
                var s = n._showCounter ? n._showCounter : null,
                    l = n._hideCounter ? n._hideCounter : null;
                l && l(!0), e.addClass("loading"), $.getJSON(ajaxurl, {
                    action: "kalium_post_like",
                    post_id: t
                }, (function(t) {
                    e.removeClass("loading"), i.removeClass([a, r].join(" ")), t.liked ? (i.addClass(a), e.addClass("liked")) : (i.addClass(r), e.removeClass("liked")), t.count && o.text(t.count)
                }))
            }
        }, e.extend({
            Likes: new n
    ...
    function($, t, e) {
        ...
        var n = function() {
                Kalium.WooCommerce.getProductContainers().each((function(t, e) {
                    if ("object" != typeof prdctfltr || "yes" !== prdctfltr.use_ajax) {
                        ...
                        n.closest(".woocommerce-products-carousel").length > 0 || n.closest(".elementor-widget-container").length > 0 || ("object" == typeof n.data("isotope") && n.data("isotope").destroy(), n.isotope(a), $(".vc_tta-tabs").on("show.vc.tab", (function() {
                            var t;
                            (n.data("isotope") && n.isotope("layout"), "undefined" != typeof Flickity) && $(this).find(".flickity-enabled").each((function(t, e) {
            ...
            i = function() {
                var t = function(t) {
                    var e = $(this),
                        n = e.children().filter(":has(img)"),
                        i = n.first().find(".image-placeholder").outerHeight(),
                        o = "current-image";
                    void 0 === e.data("galleryIndex") && e.data("galleryIndex", 0);
                    var a = e.data("galleryIndex") + t;
                    a = a < 0 ? n.length + a : a % n.length;
                    var r = n.eq(a),
                        s, l = r.find(".image-placeholder").outerHeight();
                    ...
                    }), n.removeClass(o), r.addClass(o), e.data("galleryIndex", a)
                };
                Kalium.WooCommerce.getProductContainers().on("click", ".product-images .gallery-arrow", (function(e) {
                    e.preventDefault();
                    var n = $(this).hasClass("gallery-prev") ? -1 : 1;
                    t.call($(this).parent()[0], n)
                }))
            },
            o = function(t) {
                var e = $(t);
            ...
            a = function() {
                var t = function(t, e) {
                    var n = t ? t.kalium : Kalium.WooCommerce.getThemeFragments();
                    n && "object" == typeof n && $(".cart-totals-widget[data-total-price]").each((function(t, i) {
                        var o = $(i),
                            a = o.data("total-price"),
                            r = "cart-totals-widget--hidden",
                            s = o.hasClass("cart-totals-widget--hide-empty"),
                            l = o.find(".cart-total"),
                            c = "";
                        switch (a) {
                            case "cart-total":
                                c = n.totals.cartTotal;
                                break;
                            case "cart-subtotal":
                                c = n.totals.cartSubtotal;
                                break;
                            case "cart-total-ex-tax":
                                c = n.totals.cartTotalExTax;
                                break
                        }
                        if (s) {
                            var u = 0 === n.totals.items;
                            o.hasClass(r) && !1 === u && (e = !1), o[u ? "addClass" : "removeClass"](r)
                        }
                        e ? TweenMax.to(l, .2, {
                            autoAlpha: 0,
                            onComplete: function() {
                                l.html(c), TweenMax.to(l, .2, {
                                    autoAlpha: 1,
                                    clearProps: "all"
                                })
                            }
                ...
                $(document.body).on("wc_fragments_refreshed", (function(e, n) {
                    t(n, !0)
                })), $("body").on("added_to_cart", (function(e, n, i, o) {
                    t(n, !0)
                })), t()
            },
            r = function() {
            ...
            l = function() {
                n(), Kalium.WooCommerce.initProducts(), r(), "object" == typeof prdctfltr && jQuery(document.body).on("post-load", s)
            },
            c = function() {
                this.init()
            };
        c.prototype = {
            constructor: c,
            init: function() {
                this.didInit || ($(document).on("kaliumready", l), this.didInit = !0)
            },
            initProduct: function(t) {
                ...
                if (!e.data("productInit")) {
                    if (o(t), (e.hasClass("catalog-layout-full-bg") || e.hasClass("catalog-layout-transparent-bg")) && (e.hasClass("product-type-variable") || e.hasClass("product-type-external"))) {
                        var n = e.find(".add_to_cart_button"),
                            i;
                        e.find(".add-to-cart-column").tooltip({
                            title: n.text(),
                            placement: "left"
                        })
                    }
            ...
            if (e && !(!1 in e)) {
                var n = Kalium.WooCommerce.getProductsArchive(),
                    i = $(e.items).find(".product"),
                    o = $(t).scrollTop();
                n.isotope("insert", i), $(t).scrollTop(o), Kalium.WooCommerce.initProducts()
            }
        }, e.extend({
            WooCommerce: new c
        })
    ...
    function($, t, e) {
        ...
        var n = ".woocommerce-product-gallery__image",
            i = n + " a",
            o = $(".kalium-woocommerce-product-gallery"),
            a, r = function(t, e) {
                var n = t.find(".main-product-images"),
                    o = t.find(".thumbnails"),
                    a = e.carousel.autoPlay > 0 && 1e3 * e.carousel.autoPlay;
                if ("undefined" != typeof Flickity) {
                    var r = new Flickity(n[0], {
                            wrapAround: !0,
                            pageDots: !1,
                            arrowShape: "",
                            autoPlay: a,
            ...
            l = function(e, i) {
                e.find(n).each((function(e, n) {
                    var o, a = $(n).find("a"),
                        r = {
                            url: a.attr("href"),
                            touch: !1
                        };
                    "ontouchstart" in t && (r.on = "click"), a.trigger("zoom.destroy"), a.zoom($.extend(i, r))
                }))
            },
            c = function(t, e) {
        ...
        c.prototype.switch = function(t) {
            ...
            var t = this;
            if (this.carouselProductGallery) this.mainCarousel.unpausePlayer(), this.$mainProductImages.find(n).each((function(e, n) {
                var i;
                $(n).data("isVariationImage") && t.mainCarousel.remove(n)
            })), this.$productThumbnails.find(n).each((function(e, n) {
                var i;
                $(n).data("isVariationImage") && t.thumbCarousel && t.thumbCarousel.remove(n)
            }));
            else {
                var e = "function" == typeof Flickity ? Flickity.data(this.$mainProductImages[0]) : void 0;
                this.$mainProductImages.find(n).each((function(t, n) {
                    var i = $(n);
                    i.data("isVariationImage") && (e ? e.remove(n) : i.remove())
                }))
            }
        }, c.prototype.prepareImage = function(t) {
            var e = {},
                n = t.kalium_image;
            return e.$main = $(n.main), e.$thumb = $(n.thumb), e.$main.data("isVariationImage", !0), e.$thumb.data("isVariationImage", !0), e
        }, c.prototype.addCarouselImage = function(t) {
        ...
        }, c.prototype.canAddVariationImage = function(t) {
            var e = !1;
            if (!t) return !1;
            if ("object" == typeof t.image) {
                var n = t.image.full_src;
                this.$mainProductImages.find(i).each((function(t, i) {
                    if (n == $(i).attr("href")) return e = !0, !1
                }))
            }
            return 0 == e
        }, c.prototype.setCurrentCarouselImageFromVariation = function(t) {
            if (!t || 0 === t.kalium_image.length) return !1;
            if ("object" == typeof t.image) {
                var e = t.image.full_src,
                    n = -1;
                this.$mainProductImages.find(i).each((function(t, i) {
                    e == $(i).attr("href") && (n = t)
        ...
        var u = function() {
            o.length && (o.each((function(t, e) {
                var o = $(e),
                    a = o.find(".main-product-images"),
                    u = o.find(".thumbnails"),
                    d = JSON.parse(o.find(".product-params-js").html()),
                    h = "object" == typeof d && 1 == d.zoom.enabled,
                    f = "object" == typeof d && 1 == d.lightbox.enabled,
                    p;
                a.hasClass("carousel") ? r(o, d) : $(document).ready((function() {
                    enquire.register("screen and (max-width:" + Kalium.toPixels(Kalium.Responsive.getMobileViewportSize()) + ")", {
                        match: function() {
                            s(o, d)
                        },
                        unmatch: function() {
                            var t = Flickity.data(a[0]);
                            t && t.destroy()
                        },
                        deferSetup: !1
                    })
                ...
                var m = function(t) {
                        Kalium.WooCommerce.Single.openLightbox(t, a, d.lightbox)
                    },
                    g = function() {
                        h && l(a, d.zoom.options)
                    };
                o.on("click", ".product-gallery-lightbox-trigger", (function(t) {
                    t.preventDefault();
                    var e = $(this).closest(n).index();
                    m(e)
                })), h ? a.on("click", i, (function(t) {
                    t.preventDefault()
                })) : f && a.on("click", i, (function(t) {
                    t.preventDefault();
                    var e = $(this).parent().index();
                    m(e)
                })), $(document).ready(g);
                var v = new c(o, d);
                v.onChange = g, o.data("variationHandler", v)
            })), $(document).ready((function() {
                "wc_variations_image_update" in $.fn && "undefined" == typeof kalium_woocommerce_disable_variation_image_update && (a = $.fn.wc_variations_image_update, $.fn.wc_variations_image_update = function(t) {
                    var e, n, i = $(this).closest(".product").find(o).data("variationHandler");
                    i && i.switch(t)
                })
            })))
        };
        u.prototype.openLightbox = function(t, e, o) {
            if (e.length) {
                t %= e.find(n).length;
                var a = [];
                e.find(i).each((function(t, e) {
                    var n = $(e),
                        i = n.find(".image-placeholder > img");
                    a.push({
                        index: t,
                        src: n.attr("href"),
                        w: i.attr("width"),
                ...
                var r = $(".pswp")[0],
                    ...
                    l;
                new PhotoSwipe(r, PhotoSwipeUI_Default, a, s).init()
            }
        }, e.WooCommerce.Single = new u
    }(jQuery, window, Kalium),
    function(t, e) {
    ...
    function(t, $, e) {
        ...
        var n = $(e);
        $(document).ready((function() {
            $(".header-search-input").length && $(".header-search-input").each((function(t, e) {
                function n() {
                    if (!p) {
                        var t = .2,
                            e = TweenMax.to(c, t, {
                        ...
                        0 == d.val().trim().length ? o(.1) : (d.focus(), e.eventCallback("onComplete", (function() {}))), TweenMax.to(l, t, {
                            css: {
                                x: "shift" == h ? -5 : 0,
                                scale: "scale" == h ? .85 : 1
                            }
                ...
                function o(t) {
                    ...
                    n.staggerFromTo(g.chars, e, i, o, .010000000000000002), n.eventCallback("onComplete", (function() {
                        d.focus()
                    }))
                }
                ...
                var r = $(e),
                    s = r.find("form"),
                    l = r.find(".search-icon a"),
                    c = r.find(".search-field"),
                    u = r.find("span"),
                    d = r.find("input"),
                    h = l.data("animation"),
                    f = "search-field-visible",
                    p = r.hasClass("header-search-input--input-visible"),
                    m = r.hasClass("header-search-input--align-right"),
                    g = new SplitText(u, {
                        type: "chars"
                    });
                p || TweenMax.set(g.chars, {
                    css: {
                        autoAlpha: 0
                    }
                }), l.on("click", (function(t) {
                    t.preventDefault(), d.val().trim().length && s.submit(), r.hasClass(f) ? d.focus() : n()
                })), d.on("blur", $.debounce(50, (function(t) {
                    d.is(":focus") || document.activeElement === l[0] || i()
                }))).on("keydown", $.debounce(25, (function(t) {
                    27 != t.keyCode ? (d.val().trim().length ? a() : d.data("prevlength") > 0 && o(), d.data("prevlength", d.val().length)) : i()
                })))
            }))
        }))
    }(this, jQuery, window),
    function(t, $, e) {
        ...
        jQuery(document).ready((function() {
            ...
            $(t).length && $(t).each((function(e, n) {
                var i = $(n),
                    o;
                i.find(".current-language").on("click", (function(t) {
                    t.preventDefault(), i.toggleClass("hover")
                }));
                var a = function() {
                        i.addClass("hover")
                    },
                ...
                if ("click" === i.data("showOn")) {
                    var s = function(e) {
                        var n;
                        i.hasClass("hover") && ($(e.target).parents(t).length || r())
                    };
    ...
    function(t, $) {
        ...
        var e = $(t),
            ...
            o = function(e) {
                if (void 0 !== this) {
                    ...
                    "object" == typeof e && (this.args = $.extend(!0, o, e)), n.hash = t.location.hash.toString().replace("#", ""), n.init(), imagesLoaded($("#" + this.args.containerId), (function() {
                        $.each(i, (function(t, e) {
                            e.refresh()
                        }))
                    }))
        ...
        o.prototype.init = function() {
            var o = this,
                ...
                r = $("#" + a.containerId);
            if (r.length) {
                if (n || (n = new ScrollMagic.Controller), a.autoOffset) {
                    var s = 0;
                    Kalium.Header.Sticky && (s += Kalium.Header.Sticky.getStickyHeight()), o.offset = s
                }
                if (a.autoHighlight) {
                    var l = $("header.site-header"),
                        c = l.offset().top + l.outerHeight();
                    $.each(a.autoHighlightItems, (function(s, l) {
                        var u = l.activeClass.join(" "),
                            d = $(l.selector),
                            h = [];
                        if (d.find('a[href*="#"]').each((function(t, e) {
                                var n = $(e).attr("href"),
                                    i;
                                n.substr(n.indexOf("#") + 1) === a.containerId && h.push($(e).parent().get(0))
                            })), h.length) {
                            var f = $(h),
                                p = new ScrollMagic.Scene({
                                    triggerHook: c / e.height(),
                                    triggerElement: r.get(0),
                                    duration: r.outerHeight(!0)
                                });
                            p.on("enter", (function() {
                                d.removeClass(u), f.addClass(u)
                            })), p.on("leave", (function() {
                                f.removeClass(u)
                            })), p.addTo(n), Kalium.isDebugMode() && p.addIndicators({
                                name: a.containerId
                            }), setInterval((function() {
                                p.duration(r.outerHeight(!0))
                            }), 1e3), i.push(p), f.find("> a").on("click", (function(e) {
                                e.preventDefault();
                                var n = $(t).scrollTop();
                                t.location.hash = $(this).attr("href").replace(/^.*#/, ""), $(t).scrollTop(n), o.scrollTo(r)
                            }))
                        }
                    }))
                }
                a.now ? o.scrollTo(r) : o.hash && o.hash === a.containerId && imagesLoaded($("#" + this.args.containerId), (function() {
                    o.scrollTo(r)
                }))
            }
        }, o.prototype.scrollTo = function(e) {
            var n = $(e).offset().top;
            Kalium.Header.Sticky && Kalium.Header.Sticky.enabled() && (n -= Kalium.Header.Sticky.getStickyHeight()), $("#wpadminbar").length > 0 && (n -= $("#wpadminbar").outerHeight()), gsap.to(t, {
                duration: 1,
                scrollTo: {
            ...
            $(document).on("click", 'a.scrollable[href*="#"], .scrollable a[href*="#"]', (function(t) {
                var e, n = $(this).attr("href"),
                    i = (n = n.replace(/^[^#]+/, "")).replace("#", "");
                0 !== $(n).length && (t.preventDefault(), new o({
                    containerId: i,
                    now: !0
                }))
            })), $(".vc_row[id], .wpb_column[id], .vc_section[id], .elementor-element[id]").each((function(t, e) {
                new o({
                    containerId: $(e).attr("id").replace("#", ""),
                    autoHighlight: !0
                })
            }))
        }))
    ...
    function(t, $, e) {
        ...
        var n = $(e),
            i = "lightGallery";
        t.kaliumLightbox = function(t, e, n) {
            var a, r = {};
        ...
        var o = function(t, e, n) {
            ...
            return "object" == typeof e && (e = $.extend(!0, i, e)), e = Kalium.Hooks.applyFilters("kaliumLightbox.LightGallery.args", e), t.lightGallery(e), t.data("lightGallery")
        }
    }(this, jQuery, window);
...
! function(t, $, e) {
    ...
    o && $.each(o, (function(t, e) {
        var i = e.callback,
            ...
            a = $(e.triggers.selector),
            r = a.parent(),
            s = {},
            l, c;
        e.loadNextPage = function() {
            a.removeClass([o.isLoading, o.isReady, o.allItemsShown].join(" ")).addClass(o.isLoading);
            var t = jQuery.extend({}, e);
            for (var l in t) "function" == typeof t[l] && delete t[l];
            t = jQuery.extend($.getQueryParameters(), t), "undefined" != typeof icl_language_code && (t.lang = icl_language_code), Kalium.Hooks.doAction("kalium-infinite-scroll-ajax-request-data", t, e), $.post(ajaxurl, t).done((function(t, l) {
                var c = t.hasOwnProperty("responseJSON") ? t.responseJSON : t;
                if (a.removeClass([o.isLoading, o.isReady, o.allItemsShown].join(" ")), "success" == l && c.success) {
                    var u = c.data;
                    if (u.fetchedItems && u.fetchedItems.length && (e.pagination.fetchedItems = e.pagination.fetchedItems.concat(u.fetchedItems)), u.hasMore) a.addClass(o.isReady), e.triggers.autoReveal && s.autoRevealScene && setTimeout((function() {
                        "DURING" == s.autoRevealScene.state() && e.loadNextPage()
                    }), 300);
                    else {
                        a.addClass(o.allItemsShown);
                        var d = new ScrollMagic.Controller,
                            h = new ScrollMagic.Scene({
                                triggerElement: e.triggers.selector,
                                triggerHook: .9
                            });
                        h.on("enter", (function(t) {
                            TweenMax.to(r, .5, {
                                delay: 3,
                                css: {
                                    autoAlpha: 0
                    ...
                    n(i, [u], e), $(document).trigger("kalium-infinite-scroll-request-done", [e, u])
                }
            }))
        }, a.on("click", (function(t) {
            t.preventDefault(), e.loadNextPage()
        })), e.triggers.autoReveal && (l = new ScrollMagic.Controller, (c = new ScrollMagic.Scene({
            triggerElement: e.triggers.selector,
            triggerHook: .9
        })).on("enter", (function(t) {
            e.pagination.totalItems > e.pagination.fetchedItems.length && e.loadNextPage()
        })).addTo(l), s.autoRevealScene = c, Kalium.isDebugMode() && c.addIndicators({
        ...
        var n = this,
            ...
            a = e.hasItems,
            r = e.hasQueryFilter,
            s = $(n.triggers.container),
            l = $(n.triggers.selector);
        if (a) {
            var c = $(e.items);
            s.append(c).isotope("appended", c).isotope("layout"), Kalium.Media.initVideoElements(), t.processPostFormatContents()
        }
    }
}(this, jQuery, window),
function($, t, e) {
    ...
    $(document).ready((function() {
        n = function(e) {
            if (!1 !== $.isFunction($.fn.isotope) && "undefined" != typeof portfolioContainers) {
                var n = $(e),
                    i = n.attr("id"),
                    o = null,
                    a = n.closest(".portfolio-container-and-title"),
                    r = a.find('.show-more[data-endless="true"]'),
                    s = r.hasClass("auto-reveal"),
                    l = null,
                    c = a.find(".product-filter"),
                    u = a.find("ul"),
                    d = c.find("a[data-term]"),
                    h = c.has(".portfolio-subcategory").length > 0,
                    f = a.find(".section-title > h1"),
                    p = a.find(".section-title .term-description"),
                    m = c.find('.portfolio-root-categories a[data-term="*"]').data("term-description"),
                    g = {},
                    v = null,
                    y = t.location.toString(),
                    b = 0,
                    w = 1 === a.find(".portfolio-title-holder--update-category-title").length,
                    C = 1 === a.find(".portfolio-title-holder--update-category-descriptions").length;
                for (var k in portfolioContainers) portfolioContainers[k].instanceId == i && (o = portfolioContainers[k]);
                var x = {
                    itemSelector: ".portfolio-item",
                    layoutMode: "fitRows"
                };
                n.hasClass("is-masonry-layout") && $.extend(x, {
                    layoutMode: "packery",
                    packery: {}
                }), n.hasClass("is-fitrows-layout") && $.extend(x, {
                    layoutMode: "fitRows"
                }), n.isotope(Kalium.Hooks.applyFilters("Kalium.Portfolio.Isotope.Options", x)), n.on("layoutComplete", (function(e, n) {
                    t.clearTimeout(b), void 0 !== wowLab && wowLab.scrollHandler(), b = setTimeout((function() {
                        scrollMonitor.recalculateLocations(), scrollMonitor.update(), b = setTimeout((function() {
                            jQuery(document).trigger("load-image-placeholders")
                        }), 1e3)
                    }), 100)
                }));
                var T = function() {
                        g = {}, $.each(o.countByTerms, (function(t, e) {
                            g[t] = 0
                        })), n.find(x.itemSelector).each((function(t, e) {
                    ...
                    S = function(t) {
                        return T(), "number" == typeof g[t] && g[t] == o.countByTerms[t]
                    },
                    M = function(e) {
                        var n = d.filter('[data-term="' + e + '"]'),
                            i = $(t).scrollTop(),
                            a = e;
                        if (0 != n.length && !Kalium.Hooks.applyFilters("Kalium.Portfolio.Filter.disableUrlChangeHistory", !1))
                            if (1 == portfolioContainers.length && history.pushState && o.filterPushState) try {
                                history.pushState({
                                    termId: e
                                }, document.title, n.attr("href"))
                            } catch (t) {
                                history.pushState({}, document.title, y)
                            } else {
                                if (portfolioContainers.length > 1) {
                                    var r = o.instanceAlias;
                                    for (var s in portfolioContainers)
                                        if (portfolioContainers[s].instanceId != o.instanceId && portfolioContainers[s].instanceAlias == r) {
                                            r = o.instanceId;
                                            break
                                        }
                                    a = r + ":" + a
                                }
                                t.location.hash = "*" == e ? "" : a, $(t).scrollTop(i)
                            }
                    },
                    A = function(t, e) {
                        t = t.toString();
                        var i = 0,
                            l = "*" == t,
                            c = 0;
                        return v = l ? "*" : t, e || M(t), n.isotope({
                            filter: function() {
                                var e = $(this),
                                    n = e.data("terms");
                                return (l || !(!n || (n = n.toString().split(" "), -1 == $.inArray(t, n)))) && (e.hasClass("is-appended") && c++, i++, !0)
                            }
                        }), o.currentTerm = v, r.length && a.find(x.itemSelector).length !== o.count && (S(t) ? 0 == c ? j("finished", !0) : j("finished") : (j("ready"), 0 == i && r.click()), s && F()), i
                    };
                ...
                var I = function(t) {
                        ...
                        if (d.parent().removeClass("active"), a || e.addClass("active"), h) {
                            var r = u.filter('[data-sub-category-of="' + n + '"]');
                            if (r.length)
                                if (u.removeClass("is-active"), a) {
                                    var s = d.filter('[data-term="' + n + '"]'),
                                        l = s.parent(),
                                        g;
                                    l.parent().hasClass("portfolio-root-categories") ? (c.removeClass("subcategory-active"), l.addClass("active")) : ((l = s.parent().not(".subcategory-back")).parent().addClass("is-active"), l.addClass("active"))
                                } else c.addClass("subcategory-active"), r.addClass("is-active");
                            else e.parent().hasClass("portfolio-root-categories") || (c.addClass("subcategory-active"), e.parent().addClass("is-active"))
                        }
                        w && ("*" === n ? f.html(t.data("title")) : f.html(i)), C && (o || "*" === n || (o = m), p.html(o))
                    },
                    E = c.find(".current a"),
                    _ = "";
                E.length && "*" != E.data("term") && (_ = E.data("term"));
                var H = c.find(".active a");
                if (H.length && "*" != H.data("term") && (v = H.data("term")), r.length) {
                    var D = function() {
                            if ("object" == typeof o && !r.data("isBusy")) {
                                r.data("isBusy", !0), o.action = "portfolio_items_get_from_ajax", o.noCategory = o.portfolioCategory = null, "*" == v ? o.noCategory = !0 : is.not.empty(v) && (o.portfolioCategory = v), o.shownIds = [], n.find(x.itemSelector).each((function(t, e) {
                        ...
                        P = function(e, i) {
                            j("ready"), e.hasMore || j("finished");
                            var o = $("<div>").html(e.html).children(),
                                a = o.find(".video-js-el").length > 0;
                            o.addClass("is-appended no-transitions opacity-none");
                            var s = $(t).scrollTop();
                            n.append(o).isotope("appended", o).isotope("layout"), $(t).scrollTop(s), o.removeClass("no-transitions opacity-none"), F(), Kalium.Media.initVideoElements(), a && "undefined" == typeof videojs && Kalium.Enqueue.loadLibrary("videojs").then((function() {
                                videojs && Kalium.Media.initVideoElements()
                            })), r.data("isBusy", !1), jQuery(document).trigger("portfolioShowMoreLoaded", [e.hasMore])
                        },
                        j = function(t, e) {
                            var n = r.parent(),
                                i = r.actual("outerHeight", {
                                    includeMargin: !0
                                });
                            switch (TweenMax.killDelayedCallsTo && TweenMax.killDelayedCallsTo(n), t) {
                                case "loading":
                                    n.removeAttr("style"), r.addClass("is-loading");
                                    break;
                                case "finished":
                                    ...
                                    r.removeClass("is-loading").addClass("is-finished"), TweenMax.to(n, .5, {
                                        height: 0,
                                        autoAlpha: 0,
                                        delay: 2
                                    });
                                ...
                                case "ready":
                                default:
                                    r.removeClass("is-loading is-finished"), n.removeClass("not-visible"), TweenMax.to(n, .5, {
                                        height: i,
                                        autoAlpha: 1,
                                        delay: 1
                                    })
                    ...
                    var F = function() {
                        s && !1 === r.hasClass("is-finished") && l.isFullyInViewport && setTimeout((function() {
                            r.click()
                        }), 10)
                    };
                    s && (l = scrollMonitor.create(r)).fullyEnterViewport((function(t) {
                        F()
                    }))
                }
                var L = t.location.hash.toString(),
                    O = "",
                    R = function() {
                        var e = t.location.hash.toString(),
                            n = "";
                        return e.length && (e = e.replace("#", "")).match(/:/) && (n = e.match(/^([^:]+)/)[1], e = e.replace(n + ":", "")), e
                    };
                if (L.length && (L = L.replace("#", "")).match(/:/) && (O = L.match(/^([^:]+)/)[1], L = L.replace(O + ":", "")), _ && (A(_, !0), I(E)), L.length > 1) {
                    var W = d.filter('[data-term="' + L + '"]');
                    W.length ? (A(L), I(W)) : o.lightboxData && $.each(o.lightboxData.entries, (function(t, e) {
                        L !== e.hash || "" !== O && O !== o.instanceAlias || portfolioLightboxOpen(e.portfolioItemId, o, e)
                    }))
                }
                if (history.state && history.state.hasOwnProperty("termId")) {
                    var K = history.state.termId,
                        Y = d.filter('[data-term="' + K + '"]');
                    A(K, !0), I(Y)
                }
                $("body").on("click", ".portfolio-holder#" + i + " .portfolio-item-type-6[data-portfolio-item-id] .item-link", (function(t) {
                    ...
                    A(e), I(d.filter((function(t, n) {
                        return $(n).data("term") == e
                    })))
                })), n.on("videojs-init", ".portfolio-item", (function(t, e) {
                    var n, i = $(e.el()).next(".portfolio-video-info");
                    if (e.controls() || !e.controls() && !e.autoplay()) {
                        var o = function() {
                                i.addClass("visible")
                            },
                            a = function() {
                        ...
                        e.on("play", a), e.on("end", o), e.on("pause", o)
                    }
                }))
            }
        }, $(".portfolio-holder:not(.blog-posts-holder, .lab-dribbble-gallery)").each((function(t, e) {
            n(e)
        })), $("body").on("click", "[data-portfolio-item-id] .thumb", (function(e) {
            var n = $(this).closest("[data-portfolio-item-id]"),
                i = n.find(".hover-state"),
                o = n.is(".portfolio-item-type-6");
            if (0 != +i.css("opacity"))
                if (!o || 0 != $(e.target).is("a") || 0 === n.find(".hover-state").length || n.hasClass("post-password-required")) {
                    if (!$(e.target).is("a") && 0 == $(e.target).closest(".like-button").length) {
                        var a = n.find(".item-link").first();
                        if ("#" == a.attr("href") || !a.attr("href")) return e.preventDefault(), !1;
                        "_blank" == a.attr("target") || macKeys.ctrlKey || macKeys.cmdKey ? t.open(a.attr("href"), null, "noopener") : o || (t.location.href = a.attr("href"))
                    }
                } else {
                    var r = n.closest(".portfolio-holder").attr("id");
                    for (var s in portfolioContainers) portfolioContainers[s].instanceId == r && portfolioLightboxOpen(n.data("portfolio-item-id"), portfolioContainers[s])
                }
            ...
            var n = $(e);
            setupSlickCarousel(n), n.on("init", (function(t) {
                $.isFunction($.fn.nivoLightbox) && n.find(".nivo a, a.nivo").nivoLightbox({
                    effect: "fade",
                    theme: "default"
                })
            })).on("afterChange", (function(t, e, n) {
                var i = $(".gallery.masonry-mode-gallery .row");
        ...
        if (e.length && $.isFunction($.fn.slick)) {
            ...
            var i = e.data("autoplay"),
                o = e.hasClass("variable-width");
            0 == i && (i = 4e3), e.slick(Kalium.Hooks.applyFilters("Kalium.Portfolio.GallerySlider.slick", {
        ...
        $(".gallery .gallery-item-description").each((function(e, n) {
            var i = $(n),
                o = i.parent().next().height(),
                a = $(".gallery-type-description").hasClass("no-spacing");
            if (i.removeClass("hidden"), !($(t).width() < 768) && i.outerHeight() > o) {
                var r = 45;
                a ? (o -= r, i.hasClass("first-entry") || (o -= r)) : o -= 30, o > 0 && (i.css({
                    height: o
                }), setupPerfectScrollbar(i, {
                    wheelPropagation: !0,
                    suppressScrollX: !0
                }))
            }
        }));
        var a = $(".portfolio-full-bg-slider");
        if (a.length) {
            var r = a.find(".image-entry"),
                s = $(".portfolio-slider-nav"),
                l = $(".portfolio-description-container"),
                c = null,
                u = !1,
                d = function(t) {
                    var e = r.eq(t).find(".video-js");
                    e.length && e[0].player && e[0].player.play()
                },
                h = function(e) {
                    a.data("autoswitch") > 0 && (t.clearInterval(c), e || (c = setInterval((function() {
                        a.data("goTo")(s.find(".current").index() + 1)
                    }), 1e3 * a.data("autoswitch"))))
                };
            r.each((function(e, n) {
                var i = $(n),
                    o = i.data("load"),
                    ...
                    l = r.length - 1;
                if (s) {
                    var c = i.find(".video-js"),
                        u = videojs(c.attr("id")),
                        d = $(u.el());
                    if (u) {
                        if (i.hasClass("fit-video-to-viewport")) {
                            function m() {
                                d.css({
                                    width: "",
                                    height: "",
                                ...
                                var e = u.width(),
                                    ...
                                    l = 0,
                                    c, h;
                                e / i < n / o ? r = n / e * (a = i) : a = e / n * (r = o), a > i && (l = (a - i) / 2), r > o && (s = (r - o) / 2), d.css({
                                    width: a,
                                    height: r,
                                    top: -s,
                                    left: -l
                            ...
                            u.ready((function() {
                                c.find("iframe").length && (d = c.find("iframe")), m()
                            })), t.addEventListener("resize", $.debounce(50, m), {
                                passive: !0
                            })
                        }
                        if (0 === e && i.hasClass("autoplay-video")) var f = setInterval((function() {
                            u.paused() ? u.play().then((function() {
                    ...
                    0 === e && (i.addClass("active"), a.addClass("is-finished"))
                } else {
                    var p = new Image;
                    p.onload = function() {
                        i.css("background-image", "url( " + o + " )").removeAttr("data-load"), 0 == e && (i.addClass("active"), a.addClass("is-finished"))
                    }, p.src = o
                }
            })), a.data("goTo", (function(t) {
                (t = Kalium.Hooks.applyFilters("Kalium.Portfolio.fullBgSliderIndex", t % r.length, a)) < 0 && (t = r.length + t);
                var e = s.find(".current"),
                    n = s.find("a").eq(t),
                    i = r.eq(t);
                e.index() != t && (e.removeClass("current"), n.addClass("current"), r.filter(".active").removeClass("active"), i.addClass("active"), r.not(i).each((function(t, e) {
                    var n = $(e).find(".video-js");
                    n.length && n[0].player && n[0].player.pause()
                })), r.eq(t).hasClass("autoplay-video") && d(t), Kalium.Hooks.doAction("Kalium.Portfolio.fullBgSliderChange", t, a))
            })), s.on("click", "a", (function(t) {
                a.data("goTo")($(this).data("index")), h(!0)
            })), $(t).on("keydown", (function(t) {
                37 == t.keyCode ? a.trigger("swiperight") : 39 == t.keyCode && a.trigger("swipeleft")
            })), a.on("swipeleft", (function() {
                a.data("goTo")(s.find(".current").index() + 1), h(!0)
            })), a.on("swiperight", (function() {
                a.data("goTo")(s.find(".current").index() - 1), h(!0)
            })), h();
            var f = function(t) {
                if (l.data("is-busy")) return !1;
                var e = l.find(".breadcrumb, .title, .project-description, .link, .services, .social-links-rounded, .social-links-plain"),
                    n = l.find(".collapse-project-info");
                if (l.data("is-busy", !0), t) {
                    l.addClass("is-collapsed");
                    var i = l.outerWidth(),
                        o = l.outerHeight();
                    l.removeClass("is-collapsed"), $(e.get().reverse()).each((function(t, e) {
                        TweenMax.to(e, .25, {
                            css: {
                                autoAlpha: 0
                            },
                        ...
                        ease: Quad.easeInOut,
                        onComplete: function() {
                            l.addClass("is-collapsed"), e.add(n).add(l).removeAttr("style"), l.data("PerfectScrollbar") && l.data("PerfectScrollbar").destroy();
                            var t = l.find(".portfolio-description-showinfo h3"),
                                i = l.find(".portfolio-description-showinfo p"),
                            ...
                            TweenMax.set(t, {
                                ...
                                onComplete: function() {
                                    t.add(i).add(o).removeAttr("style"), l.data("is-busy", !1)
                                }
                            })
                        }
                    })
                } else {
                    var a = l.find(".portfolio-description-showinfo h3"),
                        r = l.find(".portfolio-description-showinfo p"),
                        s = l.find(".expand-project-info");
                    l.removeClass("is-collapsed");
                    var c = l.outerWidth(),
                        u = l.outerHeight();
                    l.addClass("is-collapsed"), TweenMax.to(a, .25, {
                        css: {
                            autoAlpha: 0
                        },
                        delay: .2
                        ...
                        ease: Quad.easeInOut,
                        onComplete: function() {
                            a.add(r).add(s).removeAttr("style"), l.removeClass("is-collapsed"), TweenMax.set(e, {
                                css: {
                                    autoAlpha: 0
                                }
                            }), TweenMax.set(n, {
                                ...
                                onComplete: function() {
                                    e.add(n).add(l).removeAttr("style");
            ...
            l.on("click", ".collapse-project-info", (function(t) {
                ...
                l.hasClass("is-collapsed") && f(!1)
            }));
            var p = setupPerfectScrollbar(l, {
                wheelPropagation: !0,
                suppressScrollX: !0
            });
            l.hasClass("is-collapsed") && p.destroy()
        }
        $(".single-portfolio-holder.is-sticky").each((function(e, n) {
            var i = $(n),
                o = i.find(".details"),
                a = i.find(".gallery-column-env"),
                r = o.find(".project-description");
            Kalium.Responsive.getMobileViewportSize() > $(t).width() && navigator.userAgent.toLowerCase().indexOf("android") > -1 || Kalium.Scroll.sticky({
                stick: o,
                duration: a,
                scrollContainer: ".project-description"
            })
        }))
    })), jQuery(t).on("elementor/frontend/init", (function() {
...
function($, t, e) {
    ...
    $(document).ready((function() {
        t.processPostFormatContents = function() {
            ...
            $("body").hasClass("single-post") && (t.length ? t.add(".single-post .post") : t = $(".single-post .post")), t.each((function(t, n) {
                var i = $(n);
                if (!i.data("post-format-processed")) {
                    if (i.is(".format-gallery")) {
                        var o = i.find(".post-gallery-images");
                        $("body").hasClass("single-post") && (o = $(".single-post .post-gallery-images")), o.length && o.each((function(t, n) {
                            var i = $(n),
                                o = {
                                    pageDots: !1,
                                    prevNextButtons: !0,
                                    ...
                                    on: {
                                        ready: function() {
                                            i.addClass("flickity-adapt-height")
                                        }
                                    }
                                },
                                a;
                            i.data("autoswitch") && (o.autoPlay = 1e3 * +i.data("autoswitch")), new Flickity(i[0], o).on("change", (function() {
                                $.debounce(250, e)()
                            }))
                        }))
                    }
                    if (i.is(".format-video") || i.is(".format-audio")) {
                        var a = i.find(".video-js").get(0),
                            r = "is-playing";
                        if (a && setTimeout((function() {
                            ...
                            }), 100), !a && (a = i.find('iframe[src*="player.vimeo.com"]').get(0))) {
                            var s = new Vimeo.Player(a);
                            s.on("play", (function() {
                                i.addClass(r)
                            })), s.on("pause", (function() {
                                i.removeClass(r)
                    ...
                    i.data("post-format-processed", !0)
                }
            }))
        ...
        $(".blog-posts").each((function(t, e) {
            ...
            if (0 != n.find(".post").length) {
                ...
                n.hasClass("fit-rows") && (o.layoutMode = "fitRows"), $(document).trigger("kalium-blog-posts-isotope-options", [o]), i.length && TweenMax.to(i, .2, {
                    css: {
                        autoAlpha: 0
                    },
                    onComplete: function() {
                        i.remove(), n.isotope(o);
        ...
        var n = $(".blog-posts .post .post-thumbnail .post-hover .hover-icon.custom img"),
            i;
        n.length && n.attr("src").match(/\.gif(\?.*)?$/i) && $(".blog-posts").on("mouseover", ".post .post-thumbnail", (function() {
            var t = $(this).find(".post-hover .hover-icon.custom img");
            t.attr("src", t.attr("src"))
        })), $(".single.single-post").each((function(t, e) {
            var n = $(e),
                i = $(".single-post .post-image .featured-image");
            if (i.on("click", (function(t) {
                    t.preventDefault();
                    var e = i.attr("href"),
                        o = n.find(".entry-header h1").text();
                    Kalium.Media.lightbox(i, {
                        options: {
                            lightGalleryOptions: {
                                counter: !1
                            }
                        },
                        items: [new Kalium.Media.Lightbox_Item(i.attr("href"), {
                            caption: o
                        })]
                    })
        ...
        })), $(".single-post .comment[data-replied-to]:has(.comment-connector)").each((function(e, n) {
            var i = $(n),
                o = i.find(".commenter-image"),
                a = i.find(".comment-connector"),
                r = $("#" + i.data("replied-to")),
                s = r.find(".commenter-image"),
                l = r.find(".comment-text"),
                c = 28,
                u = o.offset().top - l.offset().top + c,
                d, h = (o.offset().left - s.offset().left + c) / 2;
            a.css({
                paddingTop: u,
                width: h - 1
            }).addClass("visible"), $(t).resize((function() {
                var t = o.offset().top - l.offset().top + c,
                    e, n = (o.offset().left - s.offset().left + c) / 2;
                a.css({
                    paddingTop: t,
                    width: n - 1
                })
            ...
            $(this).click((function(e) {
                ...
                if (n.match(/^http/)) {
                    var i = 750,
                        o = 530;
                    e.preventDefault(), t.open(n, "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=" + (screen.height / 2 - 265) + ", left=" + (screen.width / 2 - 375) + ", width=" + i + ", height=" + o)
                }
            }))
        }))
    }))
...
function($, t, e) {
    ...
    $(document).ready((function() {
        ...
        var n = $(".menu-cart-icon-container"),
            i = n.find(".cart-icon-link"),
            o = i.find(".items-count"),
            a = n.find(".lab-wc-mini-cart-contents"),
            r, s = $(".cart-icon-link-mobile-container .cart-icon-link-mobile").find(".items-count"),
            l = !1,
            c = "menu-cart-icon-container--hide-empty",
            u = n.hasClass(c),
            d = [];
        if (n.length) {
            var h = function() {
                    var t = a.find(".cart-items");
                    if (d.length)
                        for (var e in d) d[e].update();
                    else t.each((function(t, e) {
                        d.push(setupPerfectScrollbar($(e), {
                            wheelPropagation: !0,
                            suppressScrollX: !0
                        }))
                    }))
                ...
                f = function(e) {
                    var o = $(t).width();
                    !a.length || o < 768 ? t.location.href = i.attr("href") : (e ? e.addClass("open") : n.addClass("open"), h(), l = !0)
                },
                p = function(t) {
                    t ? t.removeClass("open") : n.removeClass("open"), l = !1
                },
                m = function(t) {
                    o.add(s).attr("class", "items-count"), s.html(t), TweenMax.to(o, .15, {
                        css: {
                            scale: 1.25
                        },
                        onComplete: function() {
                            o.html(t), TweenMax.to(o, .15, {
                                css: {
                                    scale: 1
                                }
                            })
                ...
                g = function(t) {
                    ...
                    if (o.html(t.labMiniCartCount), a.html(t.labMiniCart), m(t.labMiniCartCount), o[e ? "addClass" : "removeClass"]("hide-notification"), u) {
                        var i = n.closest(".header-block__item"),
                            r = e ? "addClass" : "removeClass";
                        n[r](c), i.length && i[r](c)
                    }
                },
                v = function() {
                    if (sessionStorage) {
                        var t = null;
                        "undefined" != typeof wc_cart_fragments_params && wc_cart_fragments_params.fragment_name && (t = $.parseJSON(sessionStorage.getItem(wc_cart_fragments_params.fragment_name))), t && g(t)
                    }
                };
            a.length && (n.hasClass("hover-show") ? n.hoverIntent({
                over: function() {
                    f(n)
                },
                out: function() {
                ...
                t.preventDefault();
                var e = $(this).closest(".menu-cart-icon-container");
                e.hasClass("open") ? p(e) : f(e)
            })), $(".dropdown").on("show.bs.dropdown", (function() {
                p()
            }))), $("body").on("adding_to_cart", (function(t, e, i) {
                n.addClass("is-loading")
            })), $("body").on("added_to_cart", (function(t, e, i, o) {
                n.removeClass("is-loading"), g(e)
            })), $(document.body).on("wc_fragments_refreshed", (function(t, e) {
                v()
            })), v(), $(t).click((function(t) {
                l && 0 == $(t.target).closest(".menu-cart-icon-container").length && p()
            }))
        }
        $(".woocommerce-ordering .dropdown-menu li a").each((function(t, e) {
            ...
            n.on("click", (function(t) {
                t.preventDefault(), n.closest(".woocommerce-ordering").fadeTo(220, .5).find(".dropdown .btn span").html(n.html()), i.find('option[value="' + n.attr("href").replace("#", "") + '"]').prop("selected", !0), i.trigger("change")
            }))
        })), $("body").on("adding_to_cart", (function(t, e, n) {
            var i;
            e.closest(".product").addClass("adding-to-cart")
        })), $(document.body).on("added_to_cart", (function(n, i, o, a) {
            if ($(document.body).trigger("Kalium.WooCommerce.AddedToCart", [i, o, a]), a) {
                var r = a[0],
                    s = a.closest(".product"),
                    l = a.next(".added-to-cart"),
                    c = s.find(".add-to-cart-icon"),
                    u = s.find(".added-to-cart-icon"),
                    d = a.data("added_to_cart_text");
                0 === l.length && (l = $("<span>").addClass("added-to-cart").html(d + ' <i class="flaticon-verification24"></i>')).insertAfter(a), setTimeout((function() {
                    s.removeClass("adding-to-cart").addClass("atc-disable-images product-added-to-cart"), "wcRevertAddToCartState" in r && (t.clearTimeout(r.wcRevertAddToCartState), r.wcRevertAddToCartState = null), u.length && (u.data("bs.tooltip") || u.tooltip({
                        title: d,
                        placement: "left",
                        trigger: "manual"
                    }), u.tooltip("show")), r.wcRevertAddToCartState = setTimeout((function() {
                        s.removeClass("atc-disable-images product-added-to-cart"), e(s[0], ":hover") || s.removeClass("hover"), u.data("bs.tooltip") && u.tooltip("hide")
                    }), 2200)
                }), 0)
            }
            ...
            if (!0 !== $(e.target).is("a")) {
                var i = n.find("h3 a");
                i.attr("target") && "_blank" == i.attr("target").toLowerCase() || macKeys.ctrlKey || macKeys.cmdKey ? t.open(i.attr("href"), null, "noopener") : t.location.href = i.attr("href")
            }
            ...
            var n = $(e),
                ...
                o = i.find("span"),
                a = function() {
                    o.html(n.find("option:selected").text())
                };
            a(),
                0 == n.next().is(".select-option-ui") && n.after(i), n.data("changeEv", a), i.append(n)
        ...
        var y = $(".main-product-images"),
            b = $(".product .summary");
        y.is(".plain.sticky") && $.debounce(10, (function() {
            ...
            var n = $(e),
                i = n.add(n.siblings(".labeled-input-row")),
                o = 0,
                a = 5,
                r = "labeled-input-row--width-group-" + (t + 1);
            i.find("label").each((function(t, e) {
                var n = $(e).outerWidth();
                n = $(e).actual("outerWidth", {
                    absolute: !0
                }), o = o < n ? n : o
            })).wrap('<div class="labeled-input-row--label"></div>'), i.addClass(r), o && i.first().before('<style id="' + r + '">.' + r + " .labeled-input-row--label {min-width:" + (o + 5) + "px}</style>")
        }))
    }))
    ...
    function($, t, e) {
        ...
        var n = {},
            i = !1;
        if ("Proxy" in t) var o = new Proxy(n, {
            get: function(t, e) {
                return n[e]
            },
            set: function(t, e, o) {
        ...
        Object.defineProperty(t, "publicVars", {
            writable: !1,
            value: o
        }), $(document).ready((function() {
            function e(t) {
            ...
            function n() {
                o.$body.removeClass("sidebar-is-opened"), o.$sidebarMenu.hasClass("sidebar-alignment-left") && o.$body.removeClass("sidebar-is-opened-left"), o.$sidebarMenu.css("transform", "translate3d(0px,0px,0px)");
                var e = getComputedStyle(o.$wrapper[0]);
                setTimeout((function() {
                    o.$wrapper.css("min-height", "")
                }), 1e3 * parseFloat(e.transitionDuration, 10)), $(t).off("keydown", a)
            }
            ...
            o.$body = $("body"), o.$wrapper = $("#main-wrapper"), o.$header = $("header.main-header"), o.$mainHeader = $("header.main-header"), o.$mainFooter = $("footer.site-footer"), o.$fullScreenMenu = o.$body.find(".site-header .fullscreen-menu"), o.$standardMenu = o.$body.find(".standard-menu-container"), o.$topMenu = o.$body.find(".top-menu-container"), o.$sidebarMenu = o.$body.find(".sidebar-menu-wrapper"), o.$sidebarMenuBar = o.$body.find('.menu-type-sidebar-menu .toggle-bars, .toggle-bars[data-action="sidebar-menu"]'), o.$mobileMenu = o.$body.find(".mobile-menu-wrapper"), o.topBorderHeight = $(".top-border").length ? $(".top-border").outerHeight() : 0, o.adminBarHeight = $(".admin-bar #wpadminbar").length ? $(".admin-bar #wpadminbar").outerHeight() : 0, $(".page_item_has_children").addClass("menu-item-has-children"), o.$fullScreenMenu.hasClass("submenu-indicator") && o.$fullScreenMenu.find(".menu-item-has-children > a").each((function(t, e) {
                $(e).append(' <i class="fas fa-angle-down"></i>')
            }));
            var s = $.debounce(100, (function() {
                    var e = $(t).height(),
                        n = o.$fullScreenMenuFooter.outerHeight();
                    o.$fullScreenMenuContainer.removeAttr("style"), r() || o.$fullScreenMenuContainer.css("max-height", e - n)
                })),
                l = function() {
                    o.fullScreenMenuOptions = {
                        toBeAnimatedClass: "to-be-animated",
                        expandAnimation: "animate-fade-slide"
                    }, o.$fullScreenMenu.length && (o.$fullScreenMenu.find("li:has(> ul)").each((function(t, e) {
                        var n = $(e),
                            i = n.find("> a"),
                            o = n.find("> ul");
                        n.hoverIntent({
                            ...
                            i.attr("href").match(/#/) && t.preventDefault()
                        }))
                    })), o.$fullScreenMenu.on("click", (function(t) {
                        var e = $(t.target);
                        (o.$fullScreenMenu[0] === t.target || e.hasClass("fullscreen-menu-navigation") || e.hasClass("container") && e.parent().hasClass("fullscreen-menu-navigation")) && h()
                    })), o.$fullScreenMenuBar = $('.menu-type-full-bg-menu .toggle-bars, .toggle-bars[data-action="fullscreen-menu"]'), o.$fullScreenMenuContainer = o.$fullScreenMenu.find(".fullscreen-menu-navigation"), o.$fullScreenMenuFooter = o.$fullScreenMenu.find(".fullscreen-menu-footer"), o.$fullScreenMenuBar.on("click", (function(t) {
                        t.preventDefault(), r() ? y() : o.$fullScreenMenuBar.hasClass("exit") ? h() : d()
                    })), o.$fullScreenMenu.on("touchstart", ".menu-item > a", (function(t) {
                        this._isTouch = this.hasOwnProperty("_isTouch") ? 2 : 1
                    })), o.$fullScreenMenu.on("click", ".menu-item > a", (function(t) {
                        Kalium.Hooks.applyFilters("Kalium.FullscreenMenu.HideMenuOnClick", !0) && (this.hasOwnProperty("_isTouch") ? 1 !== this._isTouch ? (h(), this._isTouch = 2) : this._isTouch = 1 : h())
                    })), o.$fullScreenMenu.find("form.search-form").each((function(t, e) {
                        var n = $(e),
                            i = n.find(".search-field"),
                            o = n.find("label");
                        i.val().length && n.addClass("search-filled"), i.on("keyup blur", (function() {
                            i.val().length > 0 ? n.addClass("search-filled") : n.removeClass("search-filled")
                        })), n.on("submit", (function(t) {
                            "" == jQuery.trim(i.val()) && t.preventDefault()
                        }))
                    })))
                },
                c = function(t) {
                    var e = .25,
                        n = t.parent();
                    t.show(), n.addClass(o.fullScreenMenuOptions.toBeAnimatedClass + " " + o.fullScreenMenuOptions.expandAnimation + "-in");
                    var i = t.outerHeight();
                    t.height(0), TweenMax.to(t, e, {
                        ...
                        onComplete: function() {
                            t.attr("style", ""), n.addClass(o.fullScreenMenuOptions.expandAnimation + "-out")
                        }
                ...
                u = function(t) {
                    var e = .25,
                        n = t.parent();
                    n.removeClass(o.fullScreenMenuOptions.expandAnimation + "-out"), TweenMax.to(t, e, {
                        css: {
                            height: 0
                        },
                        onComplete: function() {
                            n.removeClass(o.fullScreenMenuOptions.toBeAnimatedClass + " " + o.fullScreenMenuOptions.expandAnimation + "-in"), t.attr("style", "")
                        }
                    })
                },
                d = function() {
                    if (!o.$fullScreenMenu.data("is-busy")) {
                        var e = $(t).height();
                        if (o.$fullScreenMenu.data("is-busy", !0).css("min-height", e), o.$fullScreenMenuBar.addClass("exit"), o.$fullScreenMenuBar.removeClass(o.$fullScreenMenuBar.data("default-skin")), o.$fullScreenMenuBar.addClass(o.$fullScreenMenuBar.data("active-skin")), o.$fullScreenMenuFooter.length) {
                            var n = o.$fullScreenMenuFooter.outerHeight();
                            o.$fullScreenMenuContainer.css("max-height", e - n), $(t).on("resize", s)
                        }
                        setTimeout((function() {
                            o.$fullScreenMenu.data("is-busy", !1).addClass("menu-is-open"), o.$body.addClass("fullscreen-menu-is-open")
                        }), 200)
                    }
                },
                h = function() {
                    o.$fullScreenMenu.data("is-busy") || (o.$fullScreenMenu.data("is-busy", !0).removeClass("menu-is-open"), o.$fullScreenMenuBar.removeClass("exit"), o.$body.removeClass("fullscreen-menu-is-open"), setTimeout((function() {
                        o.$fullScreenMenuBar.removeClass(o.$fullScreenMenuBar.data("active-skin")), o.$fullScreenMenuBar.addClass(o.$fullScreenMenuBar.data("default-skin")), o.$fullScreenMenuBar.removeClass("is-fixed").removeAttr("style"), o.$fullScreenMenuFooter.length && (o.$fullScreenMenuContainer.removeAttr("style"), $(t).off("resize", s)), o.$fullScreenMenu.data("is-busy", !1)
                    }), 400))
                },
                f;
            l(), o.$standardMenu.find("li:has(> ul)").add(o.$topMenu.find("li:has(> ul)")).each((function(e, n) {
                var i = $(n),
                    o = i.find("> ul"),
                    a = "sub-visible",
                    r = function() {
                ...
                i.on("touchend", (function(t) {
                    s = !1, i.hasClass(a) || (s = !0)
                })), i.on("click", (function(t) {
                    s && t.preventDefault()
                }))
            })), o.$standardMenu.find(".toggle-bars").on("click", (function(t) {
                if (t.preventDefault(), r()) y();
                else {
                    var e = $(this);
                    o.$standardMenu.hasClass("items-visible") ? (e.removeClass("exit"), o.$standardMenu.removeClass("items-visible")) : (e.addClass("exit"), o.$standardMenu.addClass("items-visible"))
                }
            })), o.$topMenu.find(".menu > li > ul.sub-menu").each((function(t, e) {
                var n = $(e),
                    i = n.prev(),
                    o = n.outerHeight();
                n.css({
            ...
            })), $('.menu-type-top-menu .toggle-bars, .toggle-bars[data-action="top-menu"]').on("click", (function(t) {
                if (t.preventDefault(), r()) y();
                else {
                    var e = $(this);
                    p(e)
            ...
            var p = function(e) {
                var n = .6,
                    i = o.$topMenu.actual("outerHeight");
                if (!o.$topMenu.data("is-busy"))
                    if ($(t).scrollTop() > .5 * o.$topMenu.height() && !o.$topMenu.hasClass("is-visible")) {
                        var a = {
                            y: $(t).scrollTop()
                        };
                        TweenMax.to(a, .5, {
                    ...
                    } else o.$topMenu.hasClass("is-visible") && (i = 0), o.$topMenu.hasClass("is-visible") || (o.$mainHeader.addClass("no-transitions"), setTimeout((function() {
                        o.$mainHeader.removeClass("no-transitions")
                    }), 1)), o.$topMenu.data("is-busy", !0).addClass("is-visible"), e.toggleClass("exit-arrow"), $(".portfolio-full-bg-slider").length && (i ? (o.$topMenu.css({
                        zIndex: 500,
                        top: -i
                    }), TweenMax.to(o.$topMenu, n, {
                        css: {
                            top: 0
                        }
                    })) : TweenMax.to(o.$topMenu, n, {
                        css: {
                            top: -o.$topMenu.actual("outerHeight")
                        }
                    })), i > 0 && $("#wpadminbar").length && (i -= $("#wpadminbar").outerHeight()), TweenMax.to(o.$wrapper, n, {
                        css: {
                            marginTop: o.topBorderHeight + i
                        },
                        ease: Power3.easeInOut,
                        onComplete: function() {
                            o.$topMenu.data("is-busy", !1), 0 == i && o.$topMenu.removeClass("is-visible")
                        }
                    })
            };
            t.topMenuToggle = p;
            var m = o.$body.find(".sidebar-menu-disabler");
            o.$sidebarMenu.find(".sidebar-main-menu ul").first().find("> li:has(> ul)").each((function(t, n) {
                var i = $(n);
                e(i, !0), i.find("li:has(> ul)").each((function(t, n) {
                    e($(n))
                }))
            })), o.$sidebarMenu.on("click", ".sidebar-menu-close", (function(t) {
                t.preventDefault(), n()
            })), o.$sidebarMenuBar.on("click", (function(t) {
                t.preventDefault(), r() && "undefined" == typeof sidebarMenuMobileDisabled ? y() : v()
            })), m.on("click", n);
            var g = o.$sidebarMenu.find(".sidebar-menu-container");
            g.length && setupPerfectScrollbar(g, {
                wheelPropagation: !0,
                scrollYMarginOffset: 20,
                suppressScrollX: !0
            });
            var v = function() {
                o.$body.addClass("sidebar-is-opened"), o.$wrapper.css("min-height", $(t).height());
                var e = 1;
                o.$sidebarMenu.hasClass("sidebar-alignment-left") && (o.$body.addClass("sidebar-is-opened-left"), e = -1), o.$sidebarMenu.css("transform", "translate3d( " + -o.$sidebarMenu.outerWidth() * e + "px,0px,0px)"), $(t).on("keydown", a)
            };
            t.sidebarMenuOpen = v;
            var y = function() {
                    r() && (o.$body.addClass("mobile-menu-open"), $(".main-header .toggle-bars").addClass("exit"), Kalium.Header.repositionMobileMenuToggleBars())
                },
                b = function() {
                    o.$body.removeClass("mobile-menu-open"), $(".site-header .toggle-bars").removeClass("exit")
                };
            o.$mobileMenu.find('.mobile-menu-container a[href*="#"]').each((function(t, e) {
                var n = !1;
                $(e).on("touchstart", (function(t) {
                    var i = $(e).parent().find("ul"),
                        o = 0 !== i.length;
                    n = o && !i.hasClass("is-visible")
                })), $(e).on("click", (function(t) {
                    var i = e.getAttribute("href").match(/#(.*)$/);
                    $(e).hasClass("toggle-bars") || i && i.length > 0 && (n || b())
                }))
            }));
            var w = o.$mobileMenu.find(".mobile-menu-container li:has(> ul)");
            w.each((function(e, n) {
                var i = $(n),
                    a = i.find("> a"),
                    r = i.find("> ul"),
                    ...
                    u = o.$body.hasClass("mobile-menu-expand-on-click");
                i.data({
                    hoverIn: l,
                    hoverOut: c
                }), u ? i.click((function(e) {
                    if (e.preventDefault(), r.hasClass("is-visible")) {
                        var i = a.attr("href");
                        "#" !== i && (t.location.href = i)
                    } else l(), w.not($(n)).each((function(t, e) {
                        $(e).data("hoverOut")()
                    }))
                })) : (i.hoverIntent({
                    over: l,
                    ...
                    var e = a.is('[href^="#"]');
                    return !r.hasClass("is-visible") || s ? (t.preventDefault(), e && s && l(), !1) : e && r.hasClass("is-visible") ? (t.preventDefault(), c(), s = !0, !1) : void 0
                })))
            })), o.$mobileMenu.on("click", (function(t) {
                (t.target == o.$mobileMenu[0] || $(t.target).is(".mobile-menu-container")) && (t.preventDefault(), b())
            })), o.$body.on("click", ".mobile-menu-overlay, .mobile-menu-close-link", (function(t) {
                t.preventDefault(), o.$body.hasClass("mobile-menu-open") ? b() : y()
            }));
            var C = o.$mobileMenu.find(".mobile-menu-container");
            i = !0, setupPerfectScrollbar(C, {
                wheelPropagation: !0
            }), $(".full-width-container").each((function(e, n) {
                var i = $(n),
                    ...
                    a = function() {
                        ...
                        var e = $(t).width() / 2 - i.outerWidth(!0) / 2;
                        if (e -= $("#main-wrapper").offset().left, i.css({
                                marginLeft: -e,
                                marginRight: -e
                            }), o) {
                            var n = i.offset().top;
            ...
            var k = function(e, n, i) {
                var a = "stretched-image--done";
                if (e.css({
                        marginLeft: "",
                        marginRight: "",
                        marginTop: ""
                    }), 992 > $(t).width()) e.addClass(a);
                else {
                    var r = e.offset(),
                        s = r.top - o.topBorderHeight - o.adminBarHeight,
                        l = r.left - o.topBorderHeight,
                        c = $(t).width() - (l + e.outerWidth() + o.topBorderHeight);
                    switch (e.addClass(a), n) {
                        case "left":
                            e.css({
                                marginTop: -s,
                                marginLeft: -l
                    ...
                    i || $(t).resize($.debounce(100, (function() {
                        k(e, n, !0)
                    })))
                }
            };
            if ($(".left-edge-sticked").each((function(t, e) {
                ...
                var x = $("[data-lightbox-gallery]").each((function(t, e) {
                    var n = $(e),
                        i = $('[data-lightbox-gallery="' + n.data("lightbox-gallery") + '"]');
                    i.length <= 1 && i.removeAttr("data-lightbox-gallery")
                }));
                $(".nivo a, a.nivo").each((function(t, e) {
                    var n = $(e);
                    if (o.$body.hasClass("lightbox-disabled")) return n.on("click", (function(t) {
                        return t.preventDefault(), !1
                    })), !1;
                    n.nivoLightbox({
                        effect: "fade",
            ...
            if (1 == T.length) {
                var S = $('<div class="change-search-keyword-wrapper"></div>'),
                    M = $('<input type="text" />'),
                    A = T.text(),
                    I = T.outerWidth(),
                    E = T.data("search-url").replace(encodeURIComponent("%s"), "%s");
                T.wrap(S), S = T.parent(), M.attr("title", T.attr("title")), S.append(M.val(A).css({
                ...
                M.on("keydown", (function(t) {
                    -1 != $.inArray(t.which, H) && (_ = !0)
                })), M.on("keyup", (function(t) {
                    -1 == $.inArray(t.which, H) && (_ = !1)
                })), M.on("focus", (function() {
                    S.addClass("focused")
                })).on("blur", (function() {
                    S.removeClass("focused")
                })).on("keypress", (function(t) {
                    D(this.value + String.fromCharCode(t.which))
                })).on("keydown", $.debounce(1, (function(e) {
                    D(M.val()), 13 == e.which && (t.location.href = E.replace("%s", encodeURIComponent(M.val())))
                })));
                var D = function(t, e) {
                    T.html(t.replace(/\s/g, "&nbsp;").replace(/\</g, "&lt;").replace(/"/g, "&quot;"))
                }
            }
            var P = $(".gallery-type-fullbg .gallery"),
                j = $(".gallery-no-top-stick").length > 0;
            if (P.length) {
                var F = function() {
                    P.css({
                        marginLeft: 0,
                    ...
                    var e = P.offset(),
                        ...
                        i = e.top,
                        a = e.left,
                        r = n - (a + P.outerWidth() + o.topBorderHeight),
                        s = $(".details.pull-right-md").length > 0;
                    n < 992 || (j && (i = 0), i -= o.topBorderHeight, a -= o.topBorderHeight, jQuery("#wpadminbar").length && (i -= jQuery("#wpadminbar").outerHeight()), jQuery(".top-header-bar").length && (i -= jQuery(".top-header-bar").outerHeight()), o.$topMenu.hasClass("is-visible") && (i -= o.$topMenu.outerHeight() - o.topBorderHeight), s ? P.css({
                        marginTop: -i,
                        marginLeft: -a
                    }) : P.css({
                        marginTop: -i,
                ...
                F(), $(t).resize($.debounce(250, F))
            }
            var L = $(".portfolio-navigation");
            if (L.length && o.$mainFooter.is(":visible") && o.$mainFooter.offset().top > $(t).height() && L.is(".portfolio-navigation-type-fixed")) {
                var O = scrollMonitor.create(o.$mainFooter[0], {
            ...
            "function" == typeof sliderComparison && $(".comparison-image-slider").each((function(t, e) {
                var n = $(e),
                    i = n.find("> img"),
                    o = n.find(".cd-resize-img > img"),
                    a = [];
                a.push(i.data("src")), a.push(o.attr("src")), imagesLoaded(a, (function(t) {
                    sliderComparison(n)
                }))
            })), $(".lab-scroll-box[data-height]").each((function(t, e) {
                var n = $(e),
                    i = n.find("> .lab-scroll-box-content"),
                    o = n.data("height"),
                    a = setupPerfectScrollbar(i, {
                        wheelPropagation: !0,
                        suppressScrollX: !0
                    })
                ...
                var n = $(this).find("a").first(),
                    i = n.attr("href");
                "A" != e.target.tagName && ("_blank" == n.attr("target").toLowerCase().trim() ? t.open(i) : t.location.href = i)
            })), $("form.contact-form[id]").each((function(t, e) {
                function n(t) {
                    if (m.data("is-busy")) return !1;
                    var e = {
                        name: c.val(),
                        email: u.val(),
                        subject: d.val(),
                    ...
                    if (l) {
                        ...
                        e[n.attr("name")] = l.find("textarea").val(), t && (e.recaptchav3token = t)
                    }
                    if (o) {
                        var i = "";
                        if (!c.hasClass("not-required") && is.empty(c.val()) && (i += a.replace("%", c.data("label")) + "\n"), d.hasClass("is-required") && is.empty(d.val()) && (i += a.replace("%", d.data("label")) + "\n"), !u.hasClass("not-required") && is.empty(u.val()) && (i += a.replace("%", u.data("label")) + "\n"), !h.hasClass("not-required") && is.empty(h.val()) && (i += a.replace("%", h.data("label")) + "\n"), is.not.empty(i)) return alert(i), !1
                    }
                    return c.add(h).add(d.is(".is-required") ? d : $(null)).on("keyup", (function(t) {
                        $(this).val().length > 0 && $(this).parent().removeClass("has-errors")
                    })), u.on("keyup", (function(t) {
                        is.email($(this).val()) && $(this).parent().removeClass("has-errors")
                    })), c.is(":visible") && !c.hasClass("not-required") && is.empty(c.val()) && c.parent().addClass("has-errors"), u.is(":visible") && is.empty(u.val()) && u.parent().addClass("has-errors"), d.is(".is-required") && is.empty(d.val()) && d.parent().addClass("has-errors"), h.is(":visible") && !h.hasClass("not-required") && is.empty(h.val()) && h.parent().addClass("has-errors"), u.is(":visible") && is.not.email(u.val()) && u.parent().addClass("has-errors"), c.is(":visible") && !c.hasClass("not-required") && is.empty(c.val()) ? (c.focus(), c.parent().addClass("has-errors"), !1) : u.is(":visible") && !u.hasClass("not-required") && is.empty(u.val()) ? (u.focus(), u.parent().addClass("has-errors"), !1) : d.is(".is-required") && is.empty(d.val()) ? (d.focus(), d.parent().addClass("has-errors"), !1) : h.is(":visible") && !h.hasClass("not-required") && is.empty(h.val()) ? (h.focus(), h.parent().addClass("has-errors"), !1) : u.is(":visible") && is.not.email(u.val()) ? (u.select(), u.parent().addClass("has-errors"), !1) : void(!f.length || f.is(":checked") ? (m.addClass("is-loading").data("is-busy", !0), TweenMax.to(g, 4, {
                        css: {
                            width: "90%"
                        },
                        delay: .5,
                        ...
                        if (t.success) {
                            var n = c.add(u).add(d).add(h).add(f).add(l.find("div").first());
                            n.attr("readonly", !0), n.parent().fadeTo(300, .5), m.addClass("sent"), TweenMax.killTweensOf(g), TweenMax.to(g, .5, {
                                css: {
                                    width: "100%"
                                },
                                onComplete: function() {
                                    var t = function(t) {
                                        ...
                                        e = m.html();
                                    e.match(/\#/) && (e = e.replace("#", "<strong>" + t(c.val()) + "</strong>")), m.html(e), m.removeClass("is-loading").addClass("is-finished");
                                    var n = m.find(".pre-submit"),
                                        i = m.find(".success-msg"),
                                        o = i.find("i"),
                                        a = m.outerWidth();
                                    m.removeClass("is-finished"), TweenMax.to(m, .3, {
                                        css: {
                                            width: a
                                        },
                                        delay: .4,
                        ...
                        }), m.data("is-busy", !1), alert(t.data.errors)
                    }), "json")) : alert(r))
                }
                var i = $(e),
                    o = 1 == i.data("alerts"),
                    ...
                    s = i.attr("id"),
                    l = i.find(".contact-form-recaptcha"),
                    c = i.find('input[name="name"]'),
                    u = i.find('input[name="email"]'),
                    d = i.find('input[name="subject"]'),
                    h = i.find('textarea[name="message"]'),
                    f = i.find(".contact-form-privacy-policy input"),
                    p = Kalium.getVar("contact_form")[s],
                    m = i.find('button[name="send"]'),
                    g = m.find(".loading-bar span");
                l.length && ("undefined" != typeof gglcptch && "v2" !== gglcptch.options.version || c.add(u).on("keyup", (function() {
                ...
                var n = $(e),
                    i = n.data("dribbble-user"),
                    o = n.data("dribbble-count"),
                    a = n.data("dribbble-access-token");
                getShotsForID([i], n.prop("id"), o, a)
            ...
            })), $("[data-lab-parallax-ratio]").each((function(e, n) {
                var i = $(n),
                    o = $(t),
                    a = 1 - parseFloat(i.data("lab-parallax-ratio")),
                    r = i.data("lab-parallax-opacity"),
                    s = i.css("opacity"),
                    l = i.outerHeight(),
                    c = i.offset().top,
                    u = 0,
                ...
                setInterval(p = function() {
                    return 0 != m.isInViewport && (u = o.scrollTop(), d = parseInt(a * u, 10), "" !== r && (h = Math.max(0, parseFloat(Math.min(u / (l + c), 1).toFixed(2))), f = 1 - h, r > 0 && (f = 1 - h * (1 - r))), i.css({
                ...
                var n = $(e);
                0 == o.$topMenu.find(".close-top-menu").length && (o.$topMenu.append('<a href="#" class="close-top-menu">&times;</a>'), $("body").on("click", ".close-top-menu", (function(t) {
                    t.preventDefault(), p($(null)), $(".toggle-bars").removeClass("exit-arrow")
                }))), n.on("click", (function(t) {
            ...
            var R = $("footer.site-footer.fixed-footer"),
                W;
            if (R.length)
                if ($(t).height() < o.$wrapper.outerHeight() + o.$mainFooter.outerHeight() && 0 == r()) {
                    var K = R.outerHeight(),
                        Y = $('<div class="footer-spacer"></div>');
                    o.$body.append(Y), Y.css({
                        height: K
                    }), imagesLoaded(R, (function() {
                        K = R.outerHeight(), Y.css({
                            height: K
                        })
                    }));
                    var z = scrollMonitor.create(o.$wrapper);
            ...
            $(".image-placeholder.video").one((function(t) {
                ...
                var n = $(e),
                    i = n.prev();
                i.is(".placeholder") && i.on("click", (function(t) {
                    n.focus()
                }))
            })), $(".lab-blog-posts[data-masonry-mode]").each((function(t, e) {
                var n = $(e),
                    i = n.data("masonryMode");
                n.removeClass("display-loading").isotope({
                    itemSelector: ".blog-post-column",
                    layoutMode: i
                })
            })), $(".go-to-top[data-type]").each((function(e, n) {
                var i = $(n),
                    a = i.data("type"),
                    r = i.data("val"),
                    s = 0,
                    l;
                "footer" == a && (a = "percentage", r = 100, o.$mainFooter.length ? s += o.$mainFooter.outerHeight() : s += 20, s += o.topBorderHeight);
                var c = $('<div class="go-to-top-vp"></div>').css({
                        position: "absolute",
                        left: -100,
                        top: 0,
                        width: 5,
                    ...
                    u = function() {
                        var t = +r,
                            e = "percentage" === a ? "%" : "";
                        c.css("display", "none"), "%" !== e && (t = Math.min(t, $(document).height())), c.css({
                            display: "block",
                            height: t + e
                        })
                    };
                u(), $(t).on("scroll load", $.debounce(200, u)), (l = scrollMonitor.create(c)).stateChange((function() {
                    $(t).height() > o.$wrapper.outerHeight() || (l.isAboveViewport && 0 == l.isBelowViewport ? i.addClass("visible") : i.removeClass("visible"))
                })), $.debounce(500, (function() {
                    l.isAboveViewport && 0 == l.isBelowViewport && i.addClass("visible")
                ...
                if (!$(e.target).is("a")) {
                    var n = macKeys.ctrlKey || macKeys.cmdKey,
                        i = $(this).data("href");
                    n ? t.open(i) : t.location.href = i
                }
            }));
            var N = $(".page-border, .page-border div");
            N.length && setTimeout((function() {
                N.each((function(t, e) {
                    wowLab.show(e)
                }))
            }), 1), $(".social-links").on("click", ".print", (function(e) {
                e.preventDefault(), t.print()
            })), $(t).resize(), scrollMonitor.update()
        }))
    }(jQuery, window), WOW && ((wowLab = new WOW).init({
        mobile: !1
    }), wowLab.sync()), jQuery(document).ready((function($) {
        $(document).trigger("kaliumready", Kalium)
    }));