    ...
    function Plugin(action, options) {
        ...
        var that = this,
            ...
            getTarget = function() {
                ...
                return element = element.length ? element : that.getContainer().filter(selector)
            };
        ...
        (void 0 === opt || void 0 === opt.scrollTo || opt.scrollTo) && (0, ($targetElement = $((that = this).getTarget())).length) && this.$element.length && setTimeout(function() {
        ...
        var $targetElement, hash = window.location.hash;
        hash && ($targetElement = $(hash)).length && (hash = $targetElement.find('[data-vc-accordion][href="' + hash + '"],[data-vc-accordion][data-vc-target="' + hash + '"]')).length && (setTimeout(function() {
            $("html, body").animate({
                scrollTop: $targetElement.offset().top - .2 * $(window).height()
            }, 0)
        }, 300), hash.trigger("click"))
