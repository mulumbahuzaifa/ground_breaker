        ...
        function() {
            ...
            u.removeNullCharacters = function(e) {
                ...
                var t = u.getSharePrefixes(); - 1 == t.indexOf("") && t.push(""), Array.prototype.forEach.call(t, (function(t) {
                    ...
                    if (i && i.indexOf(t) >= 0 && !1 === e.hashFocusBookFound) {
                        ...
                        var n, o = i.split("/")[0].replace("#", ""),
                            a = i.split("/")[1];
                        if (null != a && (a = a.split("/")[0]), 0 === (n = r("[data-df-slug=" + o + "]")).length && (n = r("[data-slug=" + o + "]")), 0 === n.length && (n = r("#df-" + o + ",#" + o)), 0 === n.length && (n = r("[data-_slug=" + o + "]")), n.length > 0 && n.is("._df_thumb,._df_button,._df_custom,._df_link,._df_book,.df-element,.dp-element")) {
                            n = r(n[0]), e.hashFocusBookFound = !0, a = parseInt(a, 10), u.focusHash(n);
                            var s = e.activeLightBox && e.activeLightBox.app || n.data("df-app");
                            if (null != s) return s.gotoPage(a), s.hashNavigationEnabled = !0, u.focusHash(s.element), !1;
                            null != a && n.attr("data-hash-page", a), n.addClass("df-hash-focused", !0), (null != n.data("lightbox") || null != n.data("df-lightbox") || null != n.attr("href") && n.attr("href").indexOf(".pdf") > -1) && n.trigger("click")
                        }
                    }
                }))
            ...
            u.getOptions = function(e) {
                ...
                for (var t, i = /[a-z0-9][^\s,]{3,}\.[^\s,]+[a-z0-9]/gi, n = []; t = i.exec(e);) {
                    var o = t[0];
                    1 == (o.match(/@/g) || []).length ? o.match(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/gi) && n.push({
                        index: t.index,
                        length: o.length,
                        text: o
                ...
                K = function(t) {
                    ...
                    return U(n, [{
                        ...
                        value: function(e) {
                            var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                i = void 0;
                            return (i = this.app.zoomValue > 1 ? this.zoomViewer.getAnnotationElement(e, t) : j(q(n.prototype), "getAnnotationElement", this).call(this, e, t)) && (i.parentNode.classList.toggle("df-double-internal", this.isDoubleInternalPage(e)), i.parentNode.classList.toggle("df-double-internal-fix", this.isDoublePageFix(e))), i
                        }
                    }, {
                        key: "getTextElement",
                        value: function(e) {
                            var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                            return this.app.zoomValue > 1 ? this.zoomViewer.getTextElement(e, t) : j(q(n.prototype), "getTextElement", this).call(this, e, t)
                        }
                    }, {
                        key: "enterZoom",
                        value: function() {
                ...
                Me = function(t) {
                    ...
                    return ke(n, [{
                        ...
                        value: function(e) {
                            ...
                            if ((!t || "" === t.style.width) && !1 !== this.texturePowerOfTwo) {
            ...
            var Ke = function(t) {
                    ...
                    function n(t, o) {
                        return Be(this, n), t.flipbook3DTiltAngleUp = 0, t.flipbook3DTiltAngleLeft = 0, t.hasSpiral = !1, t.cover3DType !== e.FLIPBOOK_COVER_TYPE.RIDGE && t.cover3DType !== e.FLIPBOOK_COVER_TYPE.BASIC || (t.cover3DType = e.FLIPBOOK_COVER_TYPE.PLAIN), i.call(this, t, o)
                    }
                    return Ue(n, [{
                        key: "init",
                        value: function() {
                ...
                lt = function(t) {
                    ...
                    function o(t, a) {
                        ...
                        return u.pdfDocument = void 0, u._page2Ratio = void 0, u.cacheBustParameters = "?ver=" + e.version + "&pdfver=" + l.options.pdfVersion, s = function() {
                            ...
                            "function" == typeof define && i.amdO && window.requirejs ? (l.updateInfo(l.options.text.loading + " PDF Service (require) ..."), window.require.config({
                                paths: {
                        ...
                        value: function(e, t) {
                            ...
                            if (null == (n = this).textContentJoined[t] || i) {
                                ...
                                n.textOffset[t] = e.items.map((function(e, t) {
                                    return {
                                        length: a = (e.str.length || 0) + (0 == e.hasEOL ? 0 : 1),
                                        offset: (o += a) - a
                                    }
                        ...
                        value: function(e) {
                            ...
                            return new Promise((function(i, n) {
                                if (t._isValidPage(e)) try {
                                    ...
                                    null == t.textContentJoined[o] ? t.pdfDocument.getPage(o).then((function(e) {
                                        e.getTextContent().then((function(e) {
                                            t.prepareTextContent(e, o), i(t.textContentJoined[o])
                                        }))
                    ...
                    if (o || !1 !== n.options.showSearchControl) {
                        ...
                        t.innerHTML = "", i.pdfDocument.getPage(a).then((function(r) {
                            ...
                            s = r.getViewport({
                                ...
                                if (null == c && null != f && d && d.length > 0 && (c = Zt(r.items, f, d), i.searchHitItemsCache[a] = c), h && h.length > 0) {
                    ...
                    i.pdfDocument.getPage(o).then((function(a) {
                        ...
                        r = a.getViewport({
                            ...
                            if (null !== n.options && null !== n.viewer && 0 != s.length) {
                                ...
                                if (pdfjsLib.AnnotationLayer.render(l), n.options.annotationClass && "" !== n.options.annotationClass && jQuery(t).find(" > section").addClass(n.options.annotationClass), null == i.PDFLinkItemsCache[o]) jQuery(t).find("a:not([href^='#'])").map((function() {
