                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.blogs') }}" style="background: rgb(17, 17, 17)"  class="btn btb-success pull-right"> All Blogs</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addBlog">
                            <div class="form-group">
                                <label for="" class="col-md-3 control-lable">Blog Title</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="description" class="col-md-3 control-lable">Description</label>
                                <div class="col-md-8" wire:ignore>
                                    <textarea name="description" class="form-control" id="summernote"  wire:model="description">Description</textarea>
                                </div>
                                @error('description')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
